                ...
                <div class="flex flex-wrap justify-center items-center sign-up-card-section">
                    <div
                        ...
                        <button type="button" name="next"
                            class="next action-button text-lg btn h-11 leading-7 py-2 cursor-pointer focus:outline-none border border-lime-orange hover:bg-transparent hover:text-lime-orange">Next</button>
                    </div>
                </div>
            </fieldset>
                                    ...
                                    <div class="select-preferences">
                                        ...
                                        <div
                                            ...
                                            <span
                                                ...
                                                data-value="example" value="1">example 1</span>
                                            <span
                                                class="target_employer custom-option pr-4 block relative transition-all hover:bg-lime-orange hover:text-gray"
                                                data-value="example" value="2">example 2</span>
