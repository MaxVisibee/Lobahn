                                                    ...
                                                    @foreach ($companies as $company)
                                                        <li><a class="current_employer_select text-lg font-book">
                                                                <input value="{{ $company->company_name }}"
                                                                    @if ($company->id == $user->current_employer_id) checked @endif
                        ...
                        <form action="{{ url('candidate-profile-update') }}" method="POST">
                            ...
                            <div class="profile-preference-box">
                                ...
                                <div class="preferences-setting-form mt-4">
                                                ...
                                                <select id="position-title-dropdown" class="custom-dropdown"
                                                    ...
                                                    @foreach ($job_titles as $job_title)
                                                        <option value="{{ $job_title->id }}"
                                                            @if (in_array($job_title->id, $job_title_selected)) selected @endif>
                                                            {{ $job_title->job_title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select id="industries-dropdown" name="industries[]"
                                                    ...
                                                    @foreach ($industries as $industry)
                                                        <option value="{{ $industry->id }}"
                                                            @if (in_array($industry->id, $industry_selected)) selected @endif>
                                                ...
                                                <select id="Sub-sectors-dropdown" name="sub_sector_id[]"
                                                    ...
                                                    @foreach ($sub_sectors as $sub_sector)
                                                        <option value="{{ $sub_sector->id }}"
                                                            @if (in_array($sub_sector->id, $sub_sector_selected)) selected @endif>
                                            ...
                                            <div id="Functions-dropdown-container"
                                                ...
                                                <select id="Functions-dropdown" class="Functions-dropdown custom-dropdown"
                                                    ...
                                                    @foreach ($fun_areas as $fun_area)
                                                        <option value="{{ $fun_area->id }}"
                                                            @if (in_array($fun_area->id, $fun_area_selected)) selected @endif>
                                    ...
                                    <div class="md:flex justify-between mb-2">
                                        ...
                                        <div class="md:w-3/5 flex rounded-lg">
                                            <div id="contract-term-container" class="py-1 w-full">
                                                <select id="contract-term-dropdown" class=""
                                                    multiple="multiple" name="job_types[]">
                                    ...
                                    <div
                                        class="md:flex justify-between mb-2 position-target-pay2 @if (!$user->full_time_salary) hidden @endif">
                                        <div class="md:w-2/5">
                                    ...
                                    <div
                                        class="md:flex justify-between mb-2 position-target-pay4  @if (!$user->part_time_salary) hidden @endif">
                                        <div class="md:w-2/5">
                                    ...
                                    <div
                                        class="md:flex justify-between mb-2 position-target-pay5 @if (!$user->freelance_salary) hidden @endif">
                                        <div class="md:w-2/5">
                                                ...
                                                <select id="position-detail-edit-keyword-optionClass" name="keywords[]"
                                                    ...
                                                    @foreach ($keywords as $keyword)
                                                        <option value="{{ $keyword->id }}"
                                                            @if (in_array($keyword->id, $keyword_selected)) selected @endif>
                                                ...
                                                <select id="keystrength-dropdown" class="custom-dropdown"
                                                    ...
                                                    @foreach ($key_strengths as $key_strength)
                                                        <option value="{{ $key_strength->id }}"
                                                            @if (in_array($key_strength->id, $key_strength_selected)) selected @endif>
                                                ...
                                                <ul class="dropdown-menu year-dropdown bg-gray-light3 w-full"
                                                    ...
                                                    @foreach ($job_exps as $job_exp)
                                                        <li><a class="text-lg font-book"><input
                                                                    @if ($job_exp->id == $user->experience_id) checked @endif
                                            ...
                                            <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                                ...
                                                <ul class="dropdown-menu management-level-dropdown bg-gray-light3 w-full"
                                                    ...
                                                    @foreach ($carriers as $carrier)
                                                        <li><a><input @if ($carrier->id == $user->management_level_id) checked @endif
                                                                    value="{{ $carrier->carrier_level }}"
                                                                    name="carrier_level" type="radio"><span
                                                                    class="text-lg font-book"> <span
                                                    ...
                                                    <div class="w-2/4 flex justify-between bg-gray-light3 rounded-lg">
                                                        <div class="btn-group dropdown w-full position-detail-dropdown"
                                                            ...
                                                            <ul class="dropdown-menu language-dropdown bg-gray-light3 w-full"
                                                                ...
                                                                @foreach ($languages as $language)
                                                                    <li
                                                                        class="cursor-pointer language-name languageSelect">
                                                            ...
                                                            <div class="btn-group dropdown w-full position-detail-dropdown"
                                                                ...
                                                                <ul class="dropdown-menu languagebasic-dropdown bg-gray-light3 w-full"
                                                                    ...
                                                                    @foreach ($language_levels as $language_level)
                                                                        <li
                                                                            class="cursor-pointer language-level levelSelect">
                                                                            <a class="text-lg font-book">
                                                                                <input
                                            ...
                                            <div id="software-dropdown-container"
                                                ...
                                                <select id="software-dropdown" class="custom-dropdown" name="job_skills[]"
                                                    ...
                                                    @foreach ($job_skills as $job_skill)
                                                        <option value="{{ $job_skill->id }}"
                                                            @if (in_array($job_skill->id, $job_skill_selected)) selected @endif>
                                                            {{ $job_skill->job_skill }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select id="geographical-dropdown" class="custom-dropdown"
                                                    ...
                                                    @foreach ($geographicals as $geographical)
                                                        <option value="{{ $geographical->id }}"
                                                            @if (in_array($geographical->id, $geographical_selected)) selected @endif>
                                            ...
                                            <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                                ...
                                                <ul class="dropdown-menu education-dropdown bg-gray-light3 w-full"
                                                    ...
                                                    @foreach ($degree_levels as $degree_level)
                                                        <li><a class="text-lg font-book"><input
                                                                    value="{{ $degree_level->degree_name }}"
                                                                    name="degree_level"
                                                                    @if ($degree_level->id == $user->education_level_id) checked @endif
                                                                    type="radio"><span
                                                ...
                                                <select id="institutions-dropdown" class="custom-dropdown"
                                                    ...
                                                    @foreach ($institutions as $institution)
                                                        <option value="{{ $institution->id }}"
                                                            @if (in_array($institution->id, $institute_selected)) selected @endif>
                                                ...
                                                <select id="fieldstudy-dropdown" name="study_fields[]"
                                                    ...
                                                    @foreach ($study_fields as $study_field)
                                                        <option value="{{ $study_field->id }}"
                                                            @if (in_array($study_field->id, $study_field_selected)) selected @endif>
                                                ...
                                                <select id="qualifications-dropdown" class="custom-dropdown"
                                                    ...
                                                    @foreach ($qualifications as $qualification)
                                                        <option value="{{ $qualification->id }}"
                                                            @if (in_array($qualification->id, $qualification_selected)) selected @endif>
                                        ...
                                        <div class=" md:w-3/5 flex rounded-lg">
                                            <div id="contract-hour-container" class="py-1 w-full">
                                                <select id="contract-hour-dropdown" class=""
                                                    name="job_shifts[]" multiple="multiple">
