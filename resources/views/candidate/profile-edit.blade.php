                        ...
                        <div class="flex flex-col md:flex-row">
                            <div class="member-profile-image-box relative">
                                <div class="w-full text-center">
                                    ...
                                    @else
                                    <img src="{{ asset('/img/member-profile/chris-wong.png') }}" alt="profile image"
                                        class="member-profile-image" alt="profile image" class="member-profile-image"
                                        id="professional-profile-image" />
                                    @endif
                                </div>
                                ...
                                <li class="bg-gray-light3 text-base rounded-corner h-11 py-2 sm-custom-480:px-6 px-4 flex flex-row flex-wrap justify-start sm:justify-around items-center mb-2"
                                    ...
                                    <div class="custom-radios self-start">
                                        <div class="inline-block">
                                            <input type="radio" id="profile-cv-{{ $cv->id }}" @if ($cv->id ==
                                            $user->default_cv)
                                            checked
                                            @endif
                                    ...
                                    <span class="sm-custom-480:ml-3 ml-1 mr-auto text-gray cv-filename">{{ $cv->cv_file
                                        }}</span>
                            ...
                            <div class="preferences-setting-form mt-4">
                                ...
                                <div class="md:flex justify-between mb-2">
                                    ...
                                    <div class="md:w-3/5 flex md:flex-nowrap flex-wrap">
                                        <input type="number" value="{{ $user->range_from }}" placeholder=""
                                            name="range_from"
                                        ...
                                        <input type="number" value="{{ $user->range_to }}" placeholder=""
                                            name="range_to"
                                            class="rounded-lg py-2 w-full bg-gray-light3 text-gray placeholder-gray focus:outline-none font-book font-futura-pt text-lg px-3" />
                                    </div>
                                </div>
                                        ...
                                        <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                            ...
                                            <ul class="dropdown-menu people-management-dropdown bg-gray-light3 w-full"
                                                ...
                                                <li><a class="text-lg font-book"><input value="{{ $people_management }}"
                                                            ...
                                                            @if($people_management==$user->people_management_id)
                                                        checked
                                                        ...
                                                        <ul class="dropdown-menu language-dropdown bg-gray-light3 w-full"
                                                            ...
                                                            <li class="cursor-pointer language-name languageSelect">
                                                                <a class="text-lg font-book">
                                                                    <input value="{{ $language->id }}" type="radio">
                                                ...
                                                <div class="4xl-custom::w-2/5 w-2/6 flex justify-between">
                                                    <div class="flex w-full bg-gray-light3 rounded-lg">
                                                        <div class="btn-group dropdown w-full position-detail-dropdown"
                                                            ...
                                                            <input class="level_name" type="hidden" name="level_2" @if($user_language && count($user_language)==2)
                                                ...
                                                <div class="4xl-custom::w-2/5 w-2/6 flex justify-between">
                                                    <div class="flex w-full bg-gray-light3 rounded-lg">
                                                        <div class="btn-group dropdown w-full position-detail-dropdown"
                                                            ...
                                                            <input class="level_name" type="hidden" name="level_3" @if($user_language && count($user_language)> 2)
                                    ...
                                    <div class="md:w-3/5 flex justify-between y-2 rounded-lg">
                                        <div id="Desirable-dropdown-container"
                                            ...
                                            <select id="Desirable-dropdown" class="Desirable-dropdown custom-dropdown"
                                                ...
                                                @foreach ($industries as $industry)
                                                <option value="{{ $industry->id }}" @if (in_array($industry->id,
                                                    $target_employer_selected)) selected @endif>
                                                    {{ $industry->industry_name }}
                                                </option>
                                                @endforeach
                                            </select>
