...
<div class="professional-setting-bg-container bg-gray-light2 md:pt-40 pt-48 pb-40">
                ...
                <div class="w-full">
                    <div class="md:flex md:justify-between gap-12">
                        <p class="text-lg text-gray pb-6 font-book font-futura-pt">
                            Please automatically send my Snapshot Profile, Full Profile & CV to the relevant Corporate Member without any further action or authorisation on my part if an Opportunity posted by the Corporate Member registers a JSR™ Score of 80.0% or higher.
                        </p>
                        <div class="pb-2">
                            <label class="switch">
            ...
            <div class="md:flex notifications-content rounded-lg px-8 pt-4  xl:gap-3 gap-8">
                ...
                <div class="w-full">
                    <div class="md:flex md:justify-between gap-14">
                        <p class="text-lg text-gray pb-6 font-book">Please include my Snapshot Profile in the Featured Members carousel on the Lobahn Connect™ website. I understand that Corporate Members may view my Full Profile and CV via the Featured Members carousel, and that I may suspend my Snapshot Profile from being displayed in the Featured Members carousel at any time by unticking this box, at which time my Snapshot Profile will be removed from the Featured Members carousel no later than the end of the following business day.</p>
                        <div class="pb-2">
                            <label class="switch">
    ...
    <div class="justify-start pt-8 pb-24 hidden">
        <button type="button" class="uppercase focus:outline-none font-book text-gray-light3 text-lg setting-back-btn py-3">
            Back
        </button>
    </div>
</div>
