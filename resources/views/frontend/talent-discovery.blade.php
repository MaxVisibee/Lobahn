...
<div class="bg-gray-warm-pale xl:py-32 py-12">
    <div class="mx-auto footer-section letter-spacing-custom mt-4">
        <div classs="monthly-title-section">
            ...
            <p class="text-base lg:text-21 text-gray-pale leading-tight mt-3">Career Partner™ optimizes your career
                success by keeping you “top-of-mind” with leading employers. Lobahn promotes your profile and delivers
                new suitable opportunities to you as they become available on a daily basis.</p>
        </div>
