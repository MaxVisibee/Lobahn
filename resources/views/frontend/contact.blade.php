        ...
        <div class="mt-32 mb-4">
            <div class="flex flex-col">
                ...
                <div class="flex flex-row justify-between items-center mb-4">
                    ...
                    <div class="mr-auto">
                        <a href="tel:+852 9151 4706" class="text-gray-pale xl:text-2xl md:text-lg text-base">{{ $contact->phone ?? '' }}</a>
                    </div>
                </div>
                <div class="flex flex-row justify-between items-center mb-10">
                    ...
                    <div class="mr-auto">
                        <a href="mailto: info@lobahn.com" class="text-gray-pale  xl:text-2xl md:text-lg text-base">{{ $contact->email ?? '' }}</a>
                    </div>
                </div>
                <div class="flex flex-row flex-wrap items-center">
                    <a class="mr-4" href="#"><img src="./img/location/facebook.svg" alt="facebook icon" /></a>
                    <a class="mr-4" href="#"><img src="./img/location/instagram-black.svg" alt="instagram icon" /></a>
                    <a class="mr-4" href="#"><img src="./img/location/linkedin.svg" alt="linkedin icon" /></a>
                    <a class="mr-4" href="#"><img src="./img/location/twitter.svg" alt="twitter icon"
            ...
            {{csrf_field()}}
                <div class="">
                    ...
                    <div class="footer-contact">
                        <textarea name="comment" id="comment" class="message-text pl-7 bg-gray text-gray-pale text-lg py-4 rounded-corner w-full footer-contact-textarea focus:border-none" placeholder="Message"></textarea>
                    </div>
                </div>
                <div class="mt-3">
