  ...
  <div class="flex justify-between">
    <div class="flex cursor-pointer">
      ...
      <p class="text-lg text-gray-pale pl-2"><a href="{{ $previous ?? ''}}"
          style="pointer-events: none;cursor: default;text-decoration: none;opacity: 0.6;">Previous news</a></p>
      @else
    ...
    <div class="flex cursor-pointer ">
      <div class="flex self-center justify-center">
        ...
        <p class="text-lg text-gray-pale pr-2"><a href="{{ $next ?? ''}}"
            style="pointer-events: none;cursor: default;text-decoration: none;opacity: 0.6;">Next news</a></p>
        @endif
