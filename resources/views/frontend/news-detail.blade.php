        ...
        <div class="flex cursor-pointer ">
            <div class="flex self-center justify-center">
                ...
                <p class="text-lg text-gray-pale pr-2"><a href="{{ $next ?? '' }}"
                        style="pointer-events: none;cursor: default;text-decoration: none;opacity: 0.6;">Next news</a>
                </p>
                @else
                ...
                <div class="flex pt-2 pl-2">
                    <div class="flex">
                        <div class="flip-card flex">
                            ...
                            <p class="cursor-pointer focus:outline-none favbtn text-lg text-gray-pale pl-3 font-book">
                                Like</p>
                        </div>
                    ...
                    <div class="flex ml-8 sharediv">
                        ...
                        <p onclick="makeshare()" class="cursor-pointer sharebtn text-lg text-gray-pale pl-3 font-book">
                            Share</p>
                    </div>
                </div>
            </div>
