    ...
    <div class="flex flex-wrap justify-center items-center post-article-form-container">
        <div
            ...
            <div class="post-article-form px-8 mb-5">
                <p class="text-4xl text-center mb-5 font-heavy tracking-wide mt-4 text-white uppercase py-8">Post an
                    article</p>
                ...
                <div class="article-category-select-wrapper text-gray-pale flex self-center">
                    <div class="article-category-select-preferences w-full">
                        ...
                        <div
                            ...
                            <div class="py-2 pl-8 flex article-category-custom-option  pr-4 relative transition-all hover:bg-gray-light2 hover:text-gray"
                                data-value="Articles">
                                <div class="flex article-category-select-custom-icon-container">
                                    <img class="mr-2 checkedIcon1 hidden" src="./img/dashboard/checked.svg" />
                                </div>
                                <img class="pl-2" src="./img/home/discussion/red.svg" />
                                <span class="article-category-select-custom-content-container text-gray pl-4">Articles</span>
                            </div>
                            <div class="py-2 pl-8 flex article-category-custom-option  pr-4 relative transition-all hover:bg-gray-light2 hover:text-gray"
                                data-value="People">
                                <div class="flex article-category-select-custom-icon-container">
                                ...
                                <img class="pl-2" src="./img/home/discussion/lightgreen.svg" />
                                <span class="article-category-select-custom-content-container text-gray pl-4">People</span>
                            </div>
                            <div class="py-2 pl-8 flex article-category-custom-option  pr-4 relative transition-all hover:bg-gray-light2 hover:text-gray"
                                ...
                                <img class="pl-2" src="./img/home/discussion/skyblue.svg" />
                                <span class="article-category-select-custom-content-container pl-4 text-gray">Annoucements</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sign-up-form__information relative">
                    <div class="mt-4">
                        <textarea class="bg-gray font-futura-pt text-lg rounded-lg text-gray-pale sharing-post-textarea"
                            id="myTextarea" rows="10" cols="80">
                            Share your thoughts
                        </textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-center pb-8">
                    <div class="flex justify-center mr-4">
                        <button onclick="showModalBox('#post-article-success-popup')"
                    ...
                    <div class="flex justify-center">
                        <button onclick="closeModal('#post-article-popup')"
...
<div class="text-center text-white absolute top-1/2 left-1/2 popup-text-box bg-gray-light">
    <div class="flex flex-col justify-center items-center popup-text-box__container py-16 relative">
        <button class="absolute top-5 right-5 cursor-pointer focus:outline-none" onclick="closeModal('#post-article-success-popup')">
        ...
        <p class="text-gray-pale text-21 font-book letter-spacing-custom px-16 mt-2"> An admin will review the article before it will be published in the community.</p>
    </div>
    </div>  
</div>
...
<div class="xl:flex justify-center">
    <div class="xl:w-1/4 xl:mb-0 mb-8 px-0 2xl-custom-1366:mr-0 mr-4">
        <div class="pb-8 sm-custom-480:flex-col flex justify-center">
            <button onclick="showModalBox('#post-article-popup')" id="post-article-btn" class="text-lg font-book text-smoke-dark px-12 py-4
        focus:outline-none bg-lime-orange border border-lime-orange hover:bg-transparent hover:text-lime-orange start-discussion-btn 2xl-custom-1440:w-72 w-60 rounded-corner
    ...
    <div class="xl:w-3/4">
        ...
        <div class="grid lg:grid-cols-2 gap-4">
            ...
            <div class="community-post cursor-pointer md:flex bg-smoke-dark hover:bg-gray-light lg:px-8 px-4 py-6 mt-5 rounded-corner">
                    ...
                    <div class="md:flex">
                        <div class="">
                            ...
                            <div class="flex justify-between mt-3">
                                <div class="mr-4 flex">
                                    <div class="2xl:w-1/5">
                                        <img class="rounded-full w-16" src="{{ asset('/img/home/discussion/1.png') }}" />
                                    </div>
        ...
        <div class="pb-8 overflow-auto pt-12">
            <div class="flex">
                <button id="discussion-pagination1" type="button" onclick="changeDiscussionPagination(1,45)" class="uppercase focus:outline-none text-lime-orange text-lg font-book discussion-pagination-btn py-2 md:w-10 px-5 flex justify-center mr-2">
                    1
                </button>
                <button type="button" onclick="changeDiscussionPagination(2,45)" id="discussion-pagination2" class="pagination2 uppercase focus:outline-none text-lime-orange text-lg font-book discussion-pagination-btn py-2 md:w-10 px-5 flex justify-center mr-2">
                    2
                </button>
                <button type="button" id="discussion-pagination3" onclick="changeDiscussionPagination(3,45)" class="pagination3 uppercase focus:outline-none text-lime-orange text-lg font-book discussion-pagination-btn py-2 md:w-10 px-5 flex justify-center mr-2">
                </button>
                ...
                <button type="button" id="discussion-pagination43" onclick="changeDiscussionPagination(43,45)" class="pagination43 uppercase focus:outline-none text-lime-orange text-lg font-book discussion-pagination-btn py-2 md:w-10 px-5 flex justify-center mr-2">
                </button>
                <button type="button" id="discussion-pagination44" onclick="changeDiscussionPagination(44,45)" class="pagination44 uppercase focus:outline-none text-lime-orange text-lg font-book discussion-pagination-btn py-2 md:w-10 px-5 flex justify-center mr-2">
                    &gt;
                </button>
                <button type="button" id="discussion-pagination45" onclick="changeDiscussionPagination(45,45)" class="pagination45 uppercase focus:outline-none text-lime-orange text-lg font-book discussion-pagination-btn py-2 md:w-10 px-5 flex justify-center mr-2">
                    &#62;&#62;
                </button>
            </div>
        </div>
