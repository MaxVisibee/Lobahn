...
@section('content')
    ...
    <div class="bg-gray-warm-pale w-full lg:flex py-40 membertype-container">
        <div class="lg:w-6/12 w-full">
            <a href="{{ url('/individual-member-services') }}" onclick="changeMemberType('professional')"
                id="professional-tab"
                class="hover:text-white cursor-pointer text-4xl text-gray-pale font-book text-center title-underline">INDIVIDUAL
                MEMBERS</a>
            <div class="flex justify-center mt-8">
                <button type="button"
                    ...
                    <div class="flex justify-center">
                        <span class="pr-4 whitespace-nowrap"><a href="{{ url('/individual-member-services') }}">Learn
                                more</a></span>
        ...
        <div class="lg:w-6/12 w-full lg:pt-0 pt-8">
            <div onclick="changeMemberType('corporate')" class="cursor-pointer">
                <a href="javascript:void(0)" id="corporate-tab"
                            ...
                            <div>
                                ...
                                <div class="flex mt-2">
                                    <span class="text-2xl  leading-none text-gray-pale">
                                        <span class="text-2xl leading-none text-lime-orange mr-1">FREE</span>Notification &
                                        Viewing of JSR™ Matching Profiles
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mx-auto footer-section letter-spacing-custom mt-4">
            ...
            <div class="flex flex-row flex-wrap justify-center lg:justify-between items-center mt-12">
                        ...
                        <div class="pt-4 pb-8 flex flex-col justify-center items-center text-white price-label">
                            <div class="flex flex-row justify-center items-center">
                                <span class="text-lg xl:text-xl 2xl:text-2xl mr-4">HK$</span><span
                                    class="text-4xl xl:text-6xl 2xl:text-80 font-heavy">{{ $monthly_plan->package_price ?? '' }}</span>
                            </div>
                ...
                <div class="talent-monthly-card relative selected-card-style mt-8 md:mt-0 group">
                    ...
                    <div class="bg-smoke-dark bill-card rounded-corner">
                        <div class="relative">
                            <img src="./img/our-services/annual-corporate-image.png" alt="monthly image"
                                class="talent-monthly-card-image w-full" />
                            <div class="absolute top-1/2 left-1/2 billed-text w-full">
                            ...
                            <div class="absolute -bottom-2 lg:-bottom-1.5 left-1/2 save-price-text">
                                <p class="underline text-lime-orange text-lg xl:text-2xl font-heavy">Save
                                    {{ $two_year_plan->promotion_percent ?? '' }}%</p>
                            </div>
                        </div>
                        <div class="pt-12 pb-8 flex flex-col justify-center items-center text-white price-label">
                            <div class="flex flex-row justify-center items-center">
                                <span class="text-lg xl:text-xl 2xl:text-2xl mr-4">HK$</span><span
                                    class="text-4xl xl:text-6xl 2xl:text-80 font-heavy">{{ $two_year_plan->price_permonth ?? '' }}</span>
                            </div>
                            <p class="text-lg text-white mt-2 text-center price-label-text">per month billed at
                                HK${{ $two_year_plan->package_price ?? '' }} every two years</p>
                        </div>
                    </div>
                    <div class="purchase-button-section mt-5">
                        <a href="{{ url('/signup-talent') }}" class="">
                ...
                <div class="talent-monthly-card relative group mt-8 lg:mt-0">
                    ...
                    <div class="bg-smoke-dark bill-card rounded-corner">
                        <div class="relative">
                            <img src="./img/our-services/two-year-image.png" alt="monthly image"
                                class="talent-monthly-card-image w-full" />
                            <div class="absolute top-1/2 left-1/2 billed-text w-full">
                            ...
                            <div class="absolute -bottom-2 lg:-bottom-1.5 left-1/2 save-price-text">
                                <p class="underline text-lime-orange text-lg xl:text-2xl font-heavy">Save
                                    {{ $annual_plan->promotion_percent ?? '' }}%</p>
                            </div>
                        </div>
                        <div class="pt-12 pb-8 flex flex-col justify-center items-center text-white price-label">
                            <div class="flex flex-row justify-center items-center">
                                <span class="text-lg xl:text-xl 2xl:text-2xl mr-4">HK$</span><span
                                    class="text-4xl xl:text-6xl 2xl:text-80 font-heavy">{{ $annual_plan->price_permonth ?? '' }}</span>
                            </div>
                            <p class="text-lg text-white mt-2 text-center price-label-text">per month billed at
                                HK${{ $annual_plan->package_price ?? '' }} annually</p>
                        </div>
                    </div>
                    <div class="purchase-button-section mt-5">
                        <a href="{{ url('/signup-talent') }}" class="">
    ...
    <div class="guarantee-container flex justify-center w-full relative bg-lime-orange md:pt-40 md:pb-28 pt-48 pb-36">
        <div class="guarantee-contentd">
            ...
            <p class="text-center text-21 text-gray pt-6 font-book">
                ...
                commodo enim. Ut laoreet urna non libero vehicula condimentum. Sed tincidunt blandit rutrum. Mauris accongue
                nibh, a maximus nibh. Donec accumsan risus nec blandit semper.
            </p>
