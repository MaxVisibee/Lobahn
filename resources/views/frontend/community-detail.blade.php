...
<div class="relative com2-banner-box">
  ...
  <div class="absolute left-1/2 ctbanner-box text-center w-full">
    <h1 class="text-5xl leading-none text-white letter-spacing-custom ctbanner-title">{{ $community->title ?? ''}}</h1>
    <div class="">
      ...
      <div class="lg:w-95percent">
        <div class="md:flex md:justify-between">
          <div class="md:flex pb-5">
            ...
            <p class="text-lg text-gray-pale font-book">{{ $community->created_at->diffForHumans() ?? ''}}</p>
          </div>
