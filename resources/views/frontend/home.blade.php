            ...
            <div class="relative spotlight-image-container1">
                ...
                <div class="absolute spotlight-content md:px-8 px-4">
                    ...
                    <div class="flex pb-8">
                        ...
                        <p class="text-gray-pale text-21 font-book">{!! date('h:m', strtotime($title_event->event_time
                            ?? '')) !!}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-span-1">
            <div class="relative spotlight-image-container2">
                ...
                <div class="absolute spotlight-content md:px-8 px-4">
                    ...
                    <div class="flex pb-8">
                        <p class="text-gray-pale text-21 font-book pr-6">{!! date('d M Y', strtotime($event->event_date
                            ?? '')) !!}</p>
                        <p class="text-gray-pale text-21 font-book">{!! date('h:m', strtotime($event->event_time ?? ''))
                            !!}</p>
                    </div>
                </div>
            </div>
