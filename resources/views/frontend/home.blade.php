        ...
        <div class="w-full bg-gray-warm-pale py-20">
            ...
            <div class="xl:flex justify-between">
                    ...
                    <div class="flex justify-start self-center">
                        <div class="w-1/5 relative bg-gray-light px-9">
                            <div class="member-name absolute text-right px-2">
                                <p
                                    class="uppercase text-white font-book text-lg whitespace-nowrap previousImage-name-title">
                                    jock well</p>
                                <p
                                    class="uppercase text-gray-pale font-book text-lg whitespace-nowrap previousImage-position-title">
                                    Company Culture Creator
                                </p>
                            </div>
                        </div>
                        <div class="">
                            <img class="previousImage  object-cover m-auto " src="/./img/home/feature/Intersection 7.png"
                    ...
                    <div class="w-full">
                        <div class="feature-member-carousel">
                            <div class="flex ">
                                <div class="md:flex justify-center">
                                    <div class="md:w-3/6 flex">
                                        <img class="slider-image0 object-cover my-auto md:mr-0 xl:ml-4 mx-auto"
                                            src="/./img/home/feature/profile.png" style="width: 500px;height:523px;" />
                                    </div>
                                    <div class="bg-gray  feature-member-info md:px-16 px-8 pt-20 ">
                                        <p data-value="VIRGINIA NGAI"
                                            class="md:text-4xl sm-custom-480:text-3xl text-2xl font-heavy text-lime-orange slider-name-title0">
                                            VIRGINIA NGAI
                                        </p>
                                        <p data-value="Senior Creative-Strategic Leader"
                                            class="md:text-21 text-lg font-heavy text-gray-pale pb-8 slider-position-title0">
                                    ...
                                    text-lg font-book text-lime-orange"
                                                onclick="openModalBox('#sign-up-popup')">View Virginia's profile</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex ">
                                <div class="md:flex justify-center">
                                    <div class="md:w-3/6 flex">
                                        <img class="slider-image1 object-cover m-auto"
                                    ...
                                    <div class="bg-gray md:w-3/6 w-full  feature-member-info md:px-16 px-8 pt-20 ">
                                        <p data-value="SUSAN KWAN"
                                            class="uppercase md:text-4xl sm-custom-480:text-3xl text-2xl font-heavy text-lime-orange slider-name-title1">
                                            SUSAN KWAN
                                        </p>
                                        <p data-value="Company Culture Creator"
                                            class="md:text-21 text-lg font-heavy text-gray-pale pb-8 slider-position-title1">
                                            Company Culture Creator
                                        </p>
                                        <p class="md:text-21 text-lg font-heavy text-gray-pale pb-8">
                                            With nearly 20 years of experience in brand strategy, digital and journalism,
                            ...
                            <div class="flex ">
                                <div class="md:flex justify-center">
                                    <div class="md:w-3/6 flex">
                                        <img class="slider-image2 object-cover m-auto"
                                            src="/./img/home/feature/Intersection 7.png"
                                            style="width: 500px;height:523px;" />
                                    </div>
                                    <div class="bg-gray md:w-3/6 w-full  feature-member-info md:px-16 px-8 pt-20 ">
                                        <p data-value="jock well"
                                            class="uppercase md:text-4xl sm-custom-480:text-3xl text-2xl font-heavy text-lime-orange slider-name-title2">
                                            jock well
                                        </p>
                                        <p data-value="Company Culture Creator"
                                            class="md:text-21 text-lg font-heavy text-gray-pale pb-8 slider-position-title2">
                                            Company Culture Creator
                                        </p>
                                        <p class="md:text-21 text-lg font-heavy text-gray-pale pb-8">
                                            With nearly 20 years of experience in brand strategy, digital and journalism,
                ...
                <div class="xl:flex xl:w-15percent justify-end self-center">
                    ...
                    <div class="w-1/5 relative bg-gray-light px-9">
                        <div class="member-name absolute text-right px-2">
                            <p class="uppercase text-white font-book text-lg whitespace-nowrap nextImage-name-title">SUSAN
                                KWAN</p>
                            <p
    ...
    <div class="guarantee-container font-futura-pt w-full relative bg-lime-orange md:py-40 py-32 flex justify-center">
        <div class="text-center text-gray become-member-content">
            ...
            <p class="text-lg lg:text-21 pt-6 letter-spacing-custom">
                Curabitur iaculis in mi nec mattis. Ut vestibulum, lorem eget gravida tincidunt, massa metus luctus enim, ut
                ultricies ex magna nec elit.
            </p>
