    ...
    <div class="text-center text-white absolute top-1/2 left-1/2 popup-text-box bg-gray-light">
        <div
            ...
            <div class="button-bar button-bar--sign-up-btn">
                <a href="{{ route('signup') }}"" class=" btn-bar font-heavy inline-block text-lime-orange text-sm
                    lg:text-lg hover:bg-lime-orange hover:text-gray border border-lime-orange rounded-full py-4 px-4
                    mr-2 btn-pill">Sign Up</a>
                <a href="{{ route('login') }}"" class=" btn-bar font-heavy inline-block text-lime-orange text-sm
                    lg:text-lg hover:bg-lime-orange hover:text-gray border border-lime-orange rounded-full py-4 px-4
                    btn-pill active button-bar--sign-up-btn__login ">Login</a>
                                                    </div>
                            ...
                            <div class="relative spotlight-image-container1">
                                ...
                                <div class="absolute spotlight-content md:px-8 px-4">
                                    <p
                                        ...
                                        <a href="/event/{{$title_event->id}}">{{ $title_event->event_title ??
                                            ''}}</a>
                                    </p>
                                    <div class="flex pb-8">
                                        <p class="text-gray-pale text-21 font-book pr-6">{!! date('d M Y',
                                            strtotime($title_event->event_date ?? '')) !!}</p>
                                        <p class="text-gray-pale text-21 font-book">{!! date('h:m',
                                            strtotime($title_event->event_time ?? '')) !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            <div class="relative spotlight-image-container2">
                                ...
                                <div class="absolute spotlight-content md:px-8 px-4">
                                    ...
                                    <div class="flex pb-8">
                                        <p class="text-gray-pale text-21 font-book pr-6">{!! date('d M Y',
                                            strtotime($event->event_date ?? '')) !!}</p>
                                        <p class="text-gray-pale text-21 font-book">{!! date('h:m',
                                            strtotime($event->event_time ?? '')) !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
