...
@section('content')
    ...
    <div class="pt-12 px-12">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-8">
            <div class="flex justify-center self-center">
                <img class="m-auto object-contain" src="./img/home/圖層 2.png"/>
            </div>
            <div class="flex justify-center self-center">
                <img class="m-auto object-contain" src="./img/home/motherapp.png"/>
            </div>
            <div class="flex justify-center self-center">
                <img class="m-auto object-contain" src="./img/home/logo.png"/>
            </div>
            <div class="flex justify-center self-center">
                <img class="m-auto object-contain" src="./img/home/iWill_logo_V4_Chinese.png"/>
            </div>
            <div class="flex justify-center self-center">
                <img class="m-auto object-contain" src="./img/home/3dnaLogo.png"/>
            </div>
            <div class="flex justify-center self-center">
                <img class="m-auto object-contain" src="./img/home/checkfirst.png"/>
            </div>
            <div class="flex justify-center self-center">
    ...
    <div class="grid md:grid-cols-2 overflow-hidden gap-4">
        <div class="md:col-span-2  relative">
            <div class="relative spotlight-image-container1">
                <div class="spotlight-image1 spotlight-img-zoom-out overflow-hidden">
                    <img src="./img/home/spotlight/1.png" class="spotlight-firstimg w-full object-contain" style="visibility: hidden;" />
                </div>
                <div class="absolute spotlight-content md:px-8 px-4">
                    <p class="uppercase text-white font-heavy xl:text-2xl md:text-xl text-lg spotlight-description leading-snug md:mt-8 mt-4">Lorem ipsum dolor sit amet,
        ...
        <div class="col-span-1">
            <div class="relative spotlight-image-container2">
                ...
                <div class="absolute spotlight-content md:px-8 px-4">
                    <p class="uppercase text-white font-heavy xl:text-2xl md:text-xl text-lg spotlight-description leading-snug md:mt-8 mt-4">Donec commodo est non accumsan luctus</p>
                    <div class="flex pb-8">
                        <p class="text-gray-pale text-21 font-book pr-6">Event Date</p>
                        <p class="text-gray-pale text-21 font-book">Event Time</p>
                    </div>
        ...
        <div class="col-span-1">
            <div class="relative spotlight-image-container3">
                ...
                <div class="absolute spotlight-content  md:px-8 px-4">
                    <p class="uppercase text-white font-heavy  xl:text-2xl md:text-xl text-lg spotlight-description leading-snug md:mt-8 mt-4">Aenean nec iaculis lorem Duis consectetur ...</p>
                    <div class="flex pb-8">
                        <p class="text-gray-pale text-21 font-book pr-6">Event Date</p>
                        <p class="text-gray-pale text-21 font-book">Event Time</p>
                    </div>
    ...
    <div class="text-center text-gray become-member-content">
        ...
        <div class="flex justify-center pt-8">
            <button type="button" class="whitespace-nowrap text-base lg:text-lg
focus:outline-none
bg-gray
text-white
py-3 lg:py-4
