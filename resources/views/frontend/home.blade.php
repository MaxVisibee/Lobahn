        ...
        <div class="home-banner-slider">
            <div class="relative home-banner-container">
                @if ($banners->banner_image)
                    <img src="{{ asset('uploads/banner_images/' . $banners->banner_image) }}"
                ...
                <div
                    ...
                    <div class="">
                        <p
                            ...
                            {{ $banners->title ?? '' }}<sup class="font-medium lg:text-32 text-lg">TM</sup></p>
            ...
            <div class="xl:flex justify-between">
                <div class="xl:flex xl:w-15percent">
                    <div class="flex justify-start self-center">
                        ...
                        <div class="">
                            <img class="previousImage  object-cover m-auto "
                            ...
                            @foreach ($seekers as $key => $seeker)
                                <div class="flex ">
                                    ...
                                    text-lg font-book text-lime-orange"
                                                    onclick="openModalBox('#sign-up-popup')">View Virginia's
                                                    profile</button>
                                            </div>
                                        </div>
                                    </div>
