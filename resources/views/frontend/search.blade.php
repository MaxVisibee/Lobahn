        ...
        <div class="md:flex">
            ...
            <div class="md:w-90percent w-full md:ml-8 md:mt-0 mt-4">
                ...
                <p class="text-21 text-gray-pale xl:result-letter-spacing">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel VPN nunc. Proin maximus ligula in
                    lectus sodales vestibulum. Curabitur feugiat est ut lectus convallis, sed ultrices lacus fermentum.
                    Praesent vehicula varius dapibus. Vestibulum ac augue erat. Fusce pretium in lorem sed viverra.
