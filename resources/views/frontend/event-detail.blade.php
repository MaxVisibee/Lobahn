  ...
  <div class="events-detail-1">
    ...
    <div class=" pl-2 pb-8">
      <p class="text-21 text-gray-pale font-book pt-4">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel<span class="text-lime-orange">pharetra</span> nunc. Proin maximus ligula in lectus sodales vestibulum. Curabitur feugiat est ut lectus convallis, sed ultrices lacus fermentum. Praesent vehicula varius dapibus. Vestibulum ac augue erat. Fusce pretium in lorem sed viverra. Aliquam in convallis felis.
      </p>
      <p class="text-21 text-gray-pale font-book pt-4">
        Duis turpis ante, scelerisque sit amet viverra ac, pulvinar sit amet orci. Proin semper tellus lorem, in sagittis neque congue a. Nam sollicitudin pulvinar arcu, a tempus nisi rhoncus in. <span class="text-lime-orange">Vestibulum</span> viverra maximus fermentum. Sed scelerisque leo augue, et vehicula tellus pellentesque at. Pellentesque nec libero ullamcorper, mattis odio quis, dapibus ligula. Nam nisl sem, vulputate quis consectetur id, tristique vitae metus. Phasellus efficitur libero vel augue maximus, ut eleifend lorem convallis. In blandit quis libero rutrum mattis.
      </p>
        </div>        
    </div>
