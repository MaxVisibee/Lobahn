...
<!-- <div id="content" class="content"> -->
  ...
  <ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Sub Sector</li>
  </ol>
  <!-- end breadcrumb -->

  <!-- begin page-header -->
  <h4 class="bold content-header"> Sub Sector Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-xs-6">
      <div>
        <a class="btn btn-primary" href="{{ route('sub_sectors.create') }}"><i class="fa fa-plus"></i> Create New Sub Sector</a>            
      </div>
    </div>
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('sub_sectors.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div
    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- sector Opportunity Managements --></h4>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('sub_sectors.show',$sector->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('sub_sectors.destroy', $sector->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Sub Sector Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'sub_sectors.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/sub_sectors_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download Sample File </a>
        </div>
