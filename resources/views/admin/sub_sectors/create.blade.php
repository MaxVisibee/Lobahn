...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Create New Sub Sector</li>
</ol>
<!-- end breadcrumb -->

<!-- begin page-header -->
<h4 class="page-header">Create New Sub Sector</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('sub_sectors.store') }}">
                {!! csrf_field() !!}
                <div class="row">
