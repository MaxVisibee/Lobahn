...
<!-- begin page-header -->
<h4 class="page-header">Create New Contact</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('contacts.store') }}">
                {!! csrf_field() !!}
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            <strong>Fax:</strong>
                            <input type="text" name="fax" id="fax" class="form-control" value="{{old('fax')}}" placeholder="Fax">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="website" id="website" class="form-control" value="{{old('website')}}" placeholder="Website">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Map :</strong>
                            <textarea id="map" name="map" class="form-control ckeditor"></textarea>
                        </div>
                    </div>
                </div>                             
                <br/>
