    ...
    <div class="panel panel-inverse">
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <!-- contact Opportunity Managements -->
        </h4>
        ...
        <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-success btn-icon btn-circle" href="{{ route('contacts.show',$contact->id) }}"><i
                    class="fas fa-eye"></i></a>
                <a class="btn btn-warning btn-icon btn-circle" href="{{ route('contacts.edit',$contact->id) }}"> <i
