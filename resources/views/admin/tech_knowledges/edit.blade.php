...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item"><a href="javascript:;">Tech Knowledge</a></li>
    <li class="breadcrumb-item active">Edit Tech Knowledge</li>
</ol>
<!-- end breadcrumb -->

<!-- begin page-header -->
<h4 class="page-header">Edit Tech Knowledge</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('tech_knowledges.update', $data->id) }}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="tech_name" id="tech_name" class="form-control" value="{{ $data->tech_name }}">
                        </div>
                    </div>                    
                </div>
                <div class="row">
