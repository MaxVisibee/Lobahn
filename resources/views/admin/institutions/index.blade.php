    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- institution Opportunity Managements --></h4>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('institutions.show',$institution->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('institutions.destroy', $institution->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
