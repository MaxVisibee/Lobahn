...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('institutions.update', $data->id) }}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="institution_name" id="institution_name" class="form-control" value="{{ $data->institution_name }}">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
