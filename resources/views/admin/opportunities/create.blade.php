                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('field_study_id[]', $study_fields, null, ['class' => 'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datepicker-disabled-past"
                                        ...
                                        <input type="text" class="form-control expire_date datepicker"
                                            placeholder="Select Date" name="expire_date" />
                                        <!-- <span class="input-group-addon"><i class="fa fa-calendar"></i></span> -->
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <div class="form-group m-b-15">
                                            ...
                                            <option value="{{ $language_level->id }}">{{ $language_level->level }}
                                            </option>
                                            @endforeach
                                        </select> --}}
                                        </div>
                            ...
                            <div class="form-group inputFormRow">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 addon_btn" style="margin-top: 15px;">
                                        <button id="add_new_row_for_addon_fee" type="button"
        ...
        <script>
            $(function() {
                ...
                $('#institution_id').select2({
                    placeholder: "Select Academic Institutions"
                });
                $('#language_id').select2({
                ...
                $('#job_skill_id').select2({
                    placeholder: "Select Software & tech knowledge"
                });
                $('#target_employer_id').select2({
                    placeholder: "Select Desirable Employer"
                });
