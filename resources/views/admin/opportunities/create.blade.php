                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input type="number" name="target_salary" id="target_salary"
                                            class="form-control" value="{{old('target_salary')}}" placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input type="number" name="full_time_salary" id="full_time_salary"
                                            class="form-control" value="{{old('full_time_salary')}}" placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input type="number" name="part_time_salary" id="part_time_salary"
                                            class="form-control" value="{{old('part_time_salary')}}" placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input type="number" name="freelance_salary" id="freelance_salary"
                                            class="form-control" value="{{old('freelance_salary')}}" placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('field_study_id[]', $study_fields, null, array('class' =>
                                'form-control')) !!}
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group m-b-15">
                                ...
                                <input type="file" name="supporting_document" class="dropify" id="supporting_document"
                                    accept=".pdf,.docx,.doc" data-allowed-file-extensions="pdf docx doc" />
                            </div>
                        </div>
