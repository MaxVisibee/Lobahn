            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    <form name="jobForm" id="jobForm" method="POST"
                        action="{{ route('opportunities.update', $data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="company_id" name="company_id" class="form-control company_id" required>
                                        ...
                                        @foreach ($companies as $id => $company)
                                            <option value="{{ $id }}"
                                                {{ (isset($data) && $data->company_id ? $data->company_id : old('company_id')) == $id ? 'selected' : '' }}>
                                                {{ $company ?? '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="keyword_id" name="keyword_id[]" class="form-control keyword_id" multiple>
                                        ...
                                        @foreach ($keywords as $id => $keyword)
                                            <option value="{{ $id }}"
                                                {{ in_array($id, old('keywords', [])) || (isset($data) && $data->keywordUsage->contains($id)) ? 'selected' : '' }}>
                                                {{ $keyword ?? '' }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('people_management', $peopleManagementLevel, null, ['placeholder' => 'Select People Management', 'class' => 'form-control', 'id' => 'people_management']) !!}
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="job_skill_id" name="job_skill_id[]" class="form-control job_skill_id"
                                        ...
                                        @foreach ($job_skills as $id => $skill)
                                            <option value="{{ $id }}"
                                                {{ in_array($id, old('job_skills', [])) || (isset($data) && $data->skillUsage->contains($id)) ? 'selected' : '' }}>
                                                {{ $skill ?? '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                'form-control')) !!} --}}
                                    <select id="field_study_id" name="field_study_id[]" class="form-control field_study_id"
                                        ...
                                        @foreach ($study_fields as $id => $field)
                                            <option value="{{ $id }}"
                                                @if (in_array($id, $study_field_selected)) selected @endif>
                                                {{ $field ?? '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="sub_sector_id" name="sub_sector_id[]" class="form-control sub_sector_id"
                                        ...
                                        @foreach ($sectors as $id => $sect)
                                            <option value="{{ $id }}"
                                                {{ in_array($id, old('sectors', [])) || (isset($data) && $data->sectorUsage->contains($id)) ? 'selected' : '' }}>
                                                {{ $sect ?? '' }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            {{-- <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control">
                                        <option value="">Select</option>
                                        <option value="Male"
                                            {{ (isset($data) && $data->gender ? $data->gender : old('gender')) == 'Male' ? 'selected' : '' }}>
                                            Male</option>
                                        <option value="Female"
                                            {{ (isset($data) && $data->gender ? $data->gender : old('gender')) == 'Female' ? 'selected' : '' }}>
                                            Female</option>
                                        <option value="Male/Female"
                                            {{ (isset($data) && $data->gender ? $data->gender : old('gender')) == 'Male/Female' ? 'selected' : '' }}>
                                            Male/Female</option>
                                    </select>
                                </div>
                            </div> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datepicker-disabled-past"
                                        ...
                                        <input type="text" class="form-control listing_date datepicker"
                                            placeholder="Select Date" name="listing_date"
                                            value="{{ $data->listing_date }}" style="border-radius: 0;" />
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                    ...
                                                    <div class="form-group addon_btn m-b-15">
                                                        ...
                                                        @else
                                                            <button id="remove_language_{{ $key + 1 }}"
                                                                onClick="removeLanguageRow({{ $key + 1 }})"
                                ...
                                @else
                                    <div class="row">
                                        ...
                                        <div class="col-xs-5">
                                            <div class="form-group m-b-15">
                                                {!! Form::select('language_level[]', $language_levels, null, ['class' => 'form-control language_level select2-default', 'id' => 'language_level']) !!}
                                            </div>
                                        </div>
                                        <div class="col-xs-2">
                                            <div class="form-group addon_btn m-b-15">
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                ...
                $('#job_type_id').select2({
                    placeholder: "Select Contrarct Term"
                });
                $('#contract_hour_id').select2({
                    placeholder: "Select Contrarct Hour"
                });
                $('#carrier_level_id').select2({
                ...
                $('#institution_id').select2({
                    placeholder: "Select Preferred Schools"
                });
                //$('#language_id').select2({placeholder:"Select Languages"});
                $('#geographical_id').select2({
                    placeholder: "Select Geographical Experiences"
                });
                $('#qualification_id').select2({
                    placeholder: "Select Qualifications"
                });
                $('#field_study_id').select2({
                    placeholder: "Select Field Of Study"
                });
                $('#key_strength_id').select2({
                ...
                $('#target_pay_id').select2({
                    placeholder: "Select Target Pay"
                });
                $('#company_id').select2({
                    placeholder: "Select Company"
                });
                $('#job_skill_id').select2({
                    placeholder: "Select Software and Tech Knowledge"
                });
                $('#target_employer_id').select2({
                    placeholder: "Select Desirable Employers"
                });
