...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::select('industry_id', $industries, null, ['placeholder' => 'Select Industry', 'class' => 'form-control', 'id' => 'industry_id', 'required' => true]) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::text('website_address', null, ['placeholder' => 'Website Address', 'class' => 'form-control', 'id' => 'website_address']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
    ...
    {{-- <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::text('established_in', null, ['placeholder' => 'Establised In', 'class' => 'form-control', 'id' => 'established_in']) !!}
        </div>
    </div> --}}
</div>
<div class="row">
    {{-- <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::select('payment_id', $payments, null, ['placeholder' => 'Select Payments', 'class' => 'form-control', 'id' => 'payment_id']) !!}
        </div>
    </div> --}}
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::text('facebook', null, ['placeholder' => 'Facebook Link', 'class' => 'form-control', 'id' => 'facebook']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            <strong>Twitter Link:</strong>
            {!! Form::text('twitter', null, ['placeholder' => 'Twitter Link', 'class' => 'form-control', 'id' => 'twitter']) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::text('linkedin', null, ['placeholder' => 'Linkedin Address', 'class' => 'form-control', 'id' => 'linkedin']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            <strong>Instragram:</strong>
            {!! Form::text('instagram', null, ['placeholder' => 'Instragram', 'class' => 'form-control', 'id' => 'instagram']) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::select('keyword_id', $keywords, null, ['placeholder' => 'Select KeyWords', 'class' => 'form-control', 'id' => 'keyword_id']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
...
{{-- <div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::select('preferred_school_id', $institutions, null, [
    'placeholder' => 'Select Preferred
            School',
    'class' => 'form-control',
    'id' => 'preferred_school_id',
]) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::select('target_employer_id', $seekers, null, [
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::number('total_impressions', null, ['placeholder' => 'Total Impressions', 'class' => 'form-control', 'id' => 'total_impressions']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            <strong>Total Clicks:</strong>
            {!! Form::number('total_clicks', null, ['placeholder' => 'Total Clicks', 'class' => 'form-control', 'id' => 'total_clicks']) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::number('total_position_listings', null, ['placeholder' => 'Total Position Listings', 'class' => 'form-control', 'id' => 'total_position_listings']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            <strong>Total Received Profiles:</strong>
            {!! Form::number('total_received_profiles', null, ['placeholder' => 'Total Received Profiles', 'class' => 'form-control', 'id' => 'total_received_profiles']) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            {!! Form::number('total_shortlists', null, ['placeholder' => 'Total Shortlists', 'class' => 'form-control', 'id' => 'total_shortlists']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            <strong>Total Connections:</strong>
            {!! Form::number('total_connections', null, ['placeholder' => 'Total Connections', 'class' => 'form-control', 'id' => 'total_connections']) !!}
        </div>
    </div>
</div> --}}
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group m-b-15">
            ...
            {!! Form::textarea('description', null, ['placeholder' => 'Employer Description', 'class' => 'form-control ckeditor', 'id' => 'description', 'rows' => 5]) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-3 col-md-3">
        ...
        <div class="form-group m-b-15">
            @if (isset($model))
                <label> <input type="checkbox" name="is_active" id="is_active" value="1"
                        @if ($model->is_active == '1') checked @endif> Is Active? </label>
            @else
                <label> {!! Form::checkbox('is_active', null, true, ['id' => 'is_active']) !!} Is Active? </label>
            @endif
        </div>
    </div>
    <div class="col-xs-12 col-sm-3 col-md-3">
