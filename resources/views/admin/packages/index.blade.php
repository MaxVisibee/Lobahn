          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>
                ...
                <a class="btn btn-warning btn-icon btn-circle" href="{{ route('packages.edit',$package->id) }}"> <i
                    class="fa fa-edit"></i></a>
                @endcan
                @can('package-delete')
                {{--
                {!! Form::open(['method' => 'DELETE','route' => ['packages.destroy',
                $package->id],'style'=>'display:inline']) !!}
