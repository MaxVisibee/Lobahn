...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        ...
        {{-- <div class="form-group m-b-15">
            ...
            'form-control','id'=>'price_permonth')) !!}
        </div> --}}
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        {{-- <div class="form-group m-b-15">
            ...
            {!! Form::number('promotion_percent', null, array('placeholder' => 'Promotion Percent','class' =>
            'form-control','id'=>'promotion_percent')) !!}
        </div> --}}
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6">
        {{-- <div class="form-group m-b-15">
            <strong>Currency :</strong>
            {!! Form::text('currency', null, array('placeholder' => 'Currency','class' =>
