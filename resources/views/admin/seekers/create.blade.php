...
@section('content')
    ...
    <h4 class="page-header">Create New Candidate</h4>
    <hr class="mt-0">
    <div class="row">
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    {!! Form::open(['route' => 'seekers.store', 'method' => 'POST', 'files' => true, 'id' => 'seekerForm', 'name' => 'seekerForm']) !!}
...
@push('scripts')
    <script>
        $(function() {
            ...
            $('#skill_id').select2({
                placeholder: "Software & tech knowledge"
            });
        ...
        function addLanguageRow() {
            ...
            $(".language-append").append(
                ...
                '<div class="col-xs-5">' +
                '<div class="form-group m-b-15">' +
                '{!! Form::select('language_level[]', $language_levels, null, ['class' => 'form-control select2-default']) !!}' +
                '</div>' +
                '</div>' +
                '<div class="col-xs-2">' +
        ...
        function addCV() {
            ...
            $(".cv-wrapper").append(
                ...
                '<button type="button" onClick="removeCV(' + cvrow +
