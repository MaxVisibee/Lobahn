...
{{-- <div class="row m-b-10">
  <div class="col-xs-6">
    <a class="btn btn-primary" href="{{ route('job_shifts.create') }}"><i class="fa fa-plus"></i> Create New Contract
      Hour</a>
  </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-warning btn-icon btn-circle" href="{{ route('job_shifts.edit',$job->id) }}"> <i
                    class="fa fa-edit"></i></a>
                <form action="{{ route('job_shifts.destroy', $job->id) }}" method="POST"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'job_shifts.import', 'method'=>'POST', 'enctype'=>'multipart/form-data',
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/contract_hour_sample_import.xlsx')}}"> <i class="fas fa-download"></i>
