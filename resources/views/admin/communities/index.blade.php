...
<!-- <div id="content" class="content"> -->
  ...
  <div class="row m-b-10">
    <div class="col-lg-12">
      <div>
        <a class="btn btn-primary" href="{{ route('communities.create') }}"><i class="fa fa-plus"></i> Create New Community</a>            
      </div>
    </div>
  </div
    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- community Opportunity Managements --></h4>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form action="{{ route('communities.destroy', $community->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
