        ...
        <div class="login login-with-news-feed">
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand" onclick="window.location='{{ route('home') }}'">
                    ...
                    <form method="POST" action="{{ url('/letadminin') }}">
                        ...
                        <div class="form-group m-b-20">
                            <input id="email" type="email"
                                class="form-control form-control-lg inverse-mode @error('email') is-invalid @enderror"
                                name="email" value="{{ old('email') }}" required placeholder="Email Address" autofocus>
                        ...
                        <div class="form-group m-b-20">
                            <input id="password" type="password"
                                class="form-control form-control-lg inverse-mode @error('password') is-invalid @enderror"
                        ...
                        <div class="checkbox checkbox-css m-b-20">
                            ...
                            @if (Route::has('password.request'))
                                <a class="mt-2 password-forgot" href="{{ route('admin.password.request') }}"
                                    style="float: right;margin-top: 0px !important;">
                        ...
                        <div class="login-buttons">
                            <button type="submit" class="btn btn-aqua btn-block btn-lg"
                                style="background: #ffdb5f;border: 1px solid #ffdb5f;">Login</button>
                        </div>
                    </form>
                </div>
                <!-- end login-content -->
