    ...
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <div class="panel-body">
                ...
                {!! Form::model($siteSetting, ['method' => 'PATCH','route' => ['edit-payment.update',
                $siteSetting->id], 'id'=>'paymentForm', 'name'=>'paymentForm', 'files'=>true]) !!}

                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group row m-b-15">
                            <strong>Stripte Key</strong>
                            {!! Form::text('stripe_key', null, array('placeholder' => 'Stripe Key','class' =>
                            'form-control','id'=>'stripe_key')) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group row m-b-15">
                            ...
                            {!! Form::text('stripe_secret', null, array('placeholder' => 'Stripe Secret','class' =>
                            'form-control','id'=>'stripe_secret')) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
