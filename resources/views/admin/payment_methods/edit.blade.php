...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('payment_methods.update', $data->id) }}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="payment_name" id="payment_name" class="form-control" value="{{ $data->payment_name }}">
                        </div>
                    </div>                    
                </div>
                <div class="row">
