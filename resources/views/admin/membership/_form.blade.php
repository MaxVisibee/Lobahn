    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            <input type="file" name="image_one" class="dropify" id="image_one"
                data-default-file="{{ $model->image_one ? url('uploads/membership/'.$model->image_one):'' }}"
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            <input type="file" name="image_two" class="dropify" id="image_two"
                data-default-file="{{ $model->image_two ? url('uploads/membership/'.$model->image_two):'' }}"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
            @else
            <input type="file" name="image_two" class="dropify" id="image_two"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            <input type="file" name="image_three" class="dropify" id="image_three"
                data-default-file="{{ $model->image_three ? url('uploads/membership/'.$model->image_three):'' }}"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
            @else
            <input type="file" name="image_three" class="dropify" id="image_three"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            <input type="file" name="image_four" class="dropify" id="image_four"
                data-default-file="{{ $model->image_four ? url('uploads/membership/'.$model->image_four):'' }}"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
            @else
            <input type="file" name="image_four" class="dropify" id="image_four"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            <input type="file" name="image_five" class="dropify" id="image_five"
                data-default-file="{{ $model->image_five ? url('uploads/membership/'.$model->image_five):'' }}"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
            @else
            <input type="file" name="image_five" class="dropify" id="image_five"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group m-b-15">
            ...
            <input type="file" name="image_six" class="dropify" id="image_six"
                data-default-file="{{ $model->image_six ? url('uploads/membership/'.$model->image_six):'' }}"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
            @else
            <input type="file" name="image_six" class="dropify" id="image_six"
                accept="image/*;capture=camera,.png,.jpg,.jpeg,.svg" data-allowed-file-extensions="jpg jpeg png svg" />
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <a class="btn btn-warning" href="{{ route('membership.edit') }}">Back to Listing</a>
