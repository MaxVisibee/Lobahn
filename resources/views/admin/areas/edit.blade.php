...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item"><a href="javascript:;">Area</a></li>
    <li class="breadcrumb-item active">Edit Area</li>
</ol>
<!-- end breadcrumb -->

<!-- begin page-header -->
<h4 class="page-header">Edit Area</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('areas.update', $data->id) }}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="area_name" id="area_name" class="form-control" value="{{ $data->area_name }}">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-warning" href="{{ route('areas.index') }}">Back to Listing</a>
