...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('news.update', $data->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                @if(isset($data))                                
                                    <input type="file" name="news_image" class="dropify" id="news_image" data-default-file="{{ $data->news_image ? url('uploads/new_image/'.$data->news_image):'' }}" accept="image/*;capture=camera,.png,.jpg,.jpeg" data-allowed-file-extensions="jpg jpeg png svg"/>
                                @else
