...
@section('content')
    ...
    <!-- begin page-header -->
    <h4 class="page-header">Edit News</h4>
    <!-- end page-header -->
        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    <form name="jobForm" id="jobForm" method="POST" action="{{ route('news.update', $data->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="imageInput">News Image</label>
                                    <div class="input-group">
                                        @if (isset($data))
                                            <input type="file" name="news_image" class="dropify" id="news_image"
                                                data-default-file="{{ $data->news_image ? url('uploads/new_image/' . $data->news_image) : '' }}"
                                    ...
                                    <select id="category_id" name="category_id" class="form-control category_id">
                                        ...
                                        @foreach ($categories as $id => $category)
                                            <option value="{{ $category->id }}" data-grade="{{ $categories }}"
                                                {{ (isset($data) && $data->category_id ? $data->category_id : old('category_id')) == $category->id? 'selected': '' }}>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="coverage_sentence" class="form-control">{{ $data->coverage_sentence }}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Descriptions :</strong>
                                    <textarea id="description" name="description" class="tinymce form-control ckeditor">{!! $data->description ?? '' !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <br />
