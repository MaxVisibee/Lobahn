...
<!-- <div id="content" class="content"> -->
  ...
  <!-- begin page-header -->
  <h4 class="bold content-header"> News Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-lg-12">
      <div>
        <a class="btn btn-primary" href="{{ route('news.create') }}"><i class="fa fa-plus"></i> Create News</a>            
      </div>
    </div>
  </div
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form action="{{ route('news.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
