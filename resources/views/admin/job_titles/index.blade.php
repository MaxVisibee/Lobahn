...
<!-- <div id="content" class="content"> -->
  ...
  <ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">JobTitle</li>
  </ol>
  <!-- end breadcrumb -->

  <!-- begin page-header -->
  <h4 class="bold content-header"> JobTitle Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-lg-12">
      <div>
        <a class="btn btn-primary" href="{{ route('job_titles.create') }}"><i class="fa fa-plus"></i> Create New JobTitle</a>            
      </div>
    </div>
  </div
