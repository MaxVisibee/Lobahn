    ...
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('job_titles.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Position Title Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'job_titles.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/position_tilte_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download Sample File </a>
        </div>
