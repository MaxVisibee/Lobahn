...
<!-- <div id="content" class="content"> -->
  ...
  <!-- begin page-header -->
  <h4 class="bold content-header">Qualification Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-xs-6">
      <div>
        <a class="btn btn-primary" href="{{ route('qualifications.create') }}"><i class="fa fa-plus"></i>Create New Qualification</a>            
      </div>
    </div>
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('qualifications.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div
    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- qualify Opportunity Managements --></h4>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('qualifications.show',$qualify->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('qualifications.destroy', $qualify->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Qualification Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'qualifications.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/qualification_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
