...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Edit Functional Area</li>
</ol>
<!-- end breadcrumb -->

<!-- begin page-header -->
<h4 class="page-header">Edit Functional Area</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('functional_areas.update', $data->id) }}">
