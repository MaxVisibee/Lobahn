...
@section('content')
    ...
    <!-- begin page-header -->
    <h4 class="bold content-header"> Terms & Conditions Management<small> </small></h4>
    <div id="footer" class="footer" style="margin-left: 0px"></div>
    <div class="row m-b-10">
        <div class="col-lg-12">
            <!-- <div>
                                                    <a class="btn btn-primary" href="{{ route('terms.create') }}"><i class="fa fa-plus"></i> Create New Terms & Conditions</a>            
                                                  </div> -->
        </div>
    </div <!-- end page-header -->
    <!-- begin row -->
                        ...
                        <tbody>
                            @foreach ($data as $key => $term)
                                <tr>
                                    ...
                                    <td>{!! DB::table('admins')->where('id', $term->created_by)->pluck('name')[0] ?? '-' !!}</td>
                                    <td>
                                        ...
                                        <!--  
                                                              <form action="{{ route('terms.destroy', $term->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
