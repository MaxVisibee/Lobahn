    ...
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('specialities.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Speciality Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'specialities.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/speciality_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
