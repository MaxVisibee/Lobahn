...
<!-- begin page-header -->
<h4 class="page-header">Edit Speciality</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('specialities.update', $data->id) }}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="speciality_name" id="speciality_name" class="form-control" value="{{ $data->speciality_name }}">
                        </div>
                    </div>                    
                </div>               
                <br/>
