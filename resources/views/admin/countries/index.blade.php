    ...
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('countries.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('countries.show',$country->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('countries.destroy', $country->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Countries Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'countries.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/countries_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
