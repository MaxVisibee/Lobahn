...
<!-- begin page-header -->
<h4 class="page-header">Create About Us</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('abouts.store') }}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="about_image" class="dropify" id="abouts_image" accept="image/*;capture=camera,.png,.jpg,.jpeg" data-allowed-file-extensions="jpg jpeg png svg"/>
