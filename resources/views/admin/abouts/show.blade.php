...
<!-- <div id="content" class="content"> -->
  ...
  <!-- begin page-header -->
  <h4 class="bold content-header"> About Us Management Details<small> </small></h4>
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-body">
           <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        <strong>About Image:</strong><br/><br/>
                       <img class="" src='{{ asset("uploads/about/$data->about_image") }}' alt="{{ $data->title ?? '-' }}" max-width="300px" height="auto">
                    </div>
                </div>
           </div>
        </div>
