    ...
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('job_types.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div>
          ...
          <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $job->is_active ?? '-' }}</td> -->
                <td>{{ isset($job->created_at)? Carbon\Carbon::parse($job->created_at)->format('d-m-Y') :'-' }}</td>
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('job_types.show',$job->id) }}"><i class="fas fa-eye"></i></a> -->
                  <a class="btn btn-warning btn-icon btn-circle" href="{{ route('job_types.edit',$job->id) }}"> <i class="fa fa-edit"></i></a>
                  <form action="{{ route('job_types.destroy', $job->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Job Types Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'job_types.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/contract_terms_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
