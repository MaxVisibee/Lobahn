        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    <form name="jobForm" id="jobForm" method="POST" action="{{ route('news_events.update', $data->id) }}"
                                    ...
                                    <div class="input-group">
                                        @if (isset($data))
                                            <input type="file" name="event_image" class="dropify" id="event_image"
                                                data-default-file="{{ $data->event_image ? url('uploads/new_image/' . $data->event_image) : '' }}"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group m-b-15">
                                    ...
                                    <input type="text" name="event_title" id="event_title" class="form-control"
                                        value="{{ $data->event_title }}" placeholder="Event Title">
                                </div>
                                <div class="form-group m-b-15">
                                    ...
                                    <div class="input-group date" id="datepicker-disabled-past"
                                        ...
                                        <input type="text" class="form-control event_date datepicker"
                                            placeholder="Select Date" name="event_date" value="{{ $data->event_date }}" />
                                    </div>
                                </div>
                                <div class="form-group m-b-15">
                                    <strong>Event Time:</strong>
                                    <input name="event_time" id="event_time" class="timepicker form-control" type="text"
                                        placeholder="Event Time" value="{{ $data->event_time }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
