...
<!-- <div id="content" class="content"> -->
  ...
  <!-- begin page-header -->
  <h4 class="bold content-header"> Events Management Details<small> </small></h4>
           ...
           <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        {{ isset($data->event_time)? $data->event_time:'-' }}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        <strong>Event Year:</strong>
                        {{ isset($data->event_year)? $data->event_year:'-' }}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        <strong>Creaged By:</strong>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                       ...
                       <img class="" src='{{ asset("uploads/events/$data->event_image") }}' alt="{{ $data->event_title ?? '-' }}" max-width="300px" height="auto">
                    </div>
                </div>
           </div>
        </div>
