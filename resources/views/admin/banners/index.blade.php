...
<!-- <div id="content" class="content"> -->
  ...
  <div class="row m-b-10">
    <div class="col-lg-12">
      <div>
        <a class="btn btn-primary" href="{{ route('banners.create') }}"><i class="fa fa-plus"></i> Create banners Banner</a>            
      </div>
    </div>
  </div
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form action="{{ route('banners.destroy', $banner->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
