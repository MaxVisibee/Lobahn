...
<div class="row m-b-10">
  <div class="col-lg-12">
    <div>
      <a class="btn btn-primary" href="{{ route('banners.create') }}"><i class="fa fa-plus"></i> Create banners
        Banner</a>
    </div>
  </div>
</div>
        ...
        <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $banner->title ?? '-' }}</td>
              <td>
                <input style="width: 100px;" type="number" class="sorting" name="sorting_{{ $banner->id }}"
                  id="sorting-{{ $banner->id }}" value="{{ $banner->sorting ?? '0' }}" data-id="{{$banner->id}}">
              </td>
              <td>
                <a class="btn btn-success btn-icon btn-circle" href="{{ route('banners.show',$banner->id) }}"><i
                    class="fas fa-eye"></i></a>
                <a class="btn btn-warning btn-icon btn-circle" href="{{ route('banners.edit',$banner->id) }}"> <i
