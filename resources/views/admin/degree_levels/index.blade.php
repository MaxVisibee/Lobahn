              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('degree_levels.show',$degree->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('degree_levels.destroy', $degree->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'degree_levels.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/education_level_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download Sample File </a>
        </div>
