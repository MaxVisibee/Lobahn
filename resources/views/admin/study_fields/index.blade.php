...
<!-- <div id="content" class="content"> -->
  ...
  <div class="row m-b-10">
    <div class="col-lg-12">
      <div>
        <a class="btn btn-primary" href="{{ route('study_fields.create') }}"><i class="fa fa-plus"></i> Create New Fields of Study</a>            
      </div>
    </div>
  </div
    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- study Opportunity Managements --></h4>
