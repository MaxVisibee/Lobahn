...
@section('content')
  ...
  <div class="row m-b-10">
    <div class="col-xs-6">
      <a class="btn btn-primary" href="{{ route('carrier_levels.create') }}"><i class="fa fa-plus"></i> Create New Management Level</a>
    </div>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('carrier_levels.show',$carrier->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('carrier_levels.destroy', $carrier->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'carrier_levels.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/management_level_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
