...
<ol class="breadcrumb float-xl-right">
  ...
  <li class="breadcrumb-item active">Management Level</li>
</ol>
<!-- end breadcrumb -->

<!-- begin page-header -->
<h4 class="bold content-header"> Management Level Management<small> </small></h4>
<div id="footer" class="footer" style="margin-left: 0px"></div>
<div class="row m-b-10">
  <div class="col-xs-6">
    <a class="btn btn-primary" href="{{ route('carrier_levels.create') }}"><i class="fa fa-plus"></i> Create New
      Management Level</a>
  </div>
  <div class="col-xs-6 text-right">
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <a class="dropdown-item" href="{{route('carrier_levels.export')}}">Export</a>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="panel-body">
        <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
          <thead>
            <tr>
              <th width="1%">No.</th>
              <th class="text-nowrap">Management Level</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input style="width: 100px;" type="number" class="sorting" name="sorting_{{ $carrier->id }}"
                  id="sorting-{{ $carrier->id }}" value="{{ $carrier->priority ?? '0' }}" data-id="{{$carrier->id}}">
              </td>
              ...
              <td>
                ...
                <a class="btn btn-warning btn-icon btn-circle" href="{{ route('carrier_levels.edit',$carrier->id) }}">
                  <i class="fa fa-edit"></i></a>
                <form action="{{ route('carrier_levels.destroy', $carrier->id) }}" method="POST"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Management Level Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'carrier_levels.import', 'method'=>'POST', 'enctype'=>'multipart/form-data',
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/management_level_sample_import.xlsx')}}"> <i class="fas fa-download"></i>
...
<script>
  $('.sorting').on('blur',function(e){    
      ...
      $.ajax({
        method : "POST",
        url: "{{ url('admin/sort-carrier_levels') }}/"+id,
        data : {
                "_token": "{{ csrf_token() }}",
                sorting : value
              },
