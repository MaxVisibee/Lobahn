...
<!-- begin page-header -->
<h4 class="bold content-header"> Job Title Categories Management Details<small> </small></h4>
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
          ...
          <div class="pull-right" style="margin-right: 10px;">
            <a class="btn btn-warning" href="{{ route('job-title-categories.index') }}"> Back to Listing </a>
          </div>
        </div>
      </div><br />
      <!-- end panel-body -->
