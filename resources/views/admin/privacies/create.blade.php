...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Create New Privacy</li>
</ol>
<!-- end breadcrumb -->

<!-- begin page-header -->
<h4 class="page-header">Create New Privacy</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('privacies.store') }}">
                {!! csrf_field() !!}
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="date" name="updated_date" id="updated_date" class="form-control" value="{{old('updated_date')}}" placeholder="Updated Date">
                        </div>
                    </div>                    
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-warning" href="{{ route('privacies.index') }}">Back to Listing</a>
