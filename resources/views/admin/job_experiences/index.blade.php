...
<!-- <div id="content" class="content"> -->
  ...
  <div class="row m-b-10">
    <div class="col-xs-6">
      <div>
        <a class="btn btn-primary" href="{{ route('job_experiences.create') }}"><i class="fa fa-plus"></i> Create New JobExperience</a>            
      </div>
    </div>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('job_experiences.show',$job->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('job_experiences.destroy', $job->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/years_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
