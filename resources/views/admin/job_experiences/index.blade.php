...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">JobExperience</li>
    </ol>
    <!-- end breadcrumb -->

    <!-- begin page-header -->
    <h4 class="bold content-header"> JobExperience Management<small> </small></h4>
    <div id="footer" class="footer" style="margin-left: 0px"></div>
    <div class="row m-b-10">
        <div class="col-xs-6">
            <div>
                {{-- <a class="btn btn-primary" href="{{ route('job_experiences.create') }}"><i class="fa fa-plus"></i> Create New
        JobExperience</a> --}}
            </div>
        </div>
        <div class="col-xs-6 text-right">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="{{ route('job_experiences.export') }}">Export</a>
                </div>
            </div>
        </div>
    </div <!-- end page-header -->
                ...
                <div class="panel-body">
                    <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
                        <thead>
                            <tr>
                                <th width="1%">No.</th>
                                <th class="text-nowrap">JobExperience</th>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px;">
                                        <input class="form-control" style="width: 100px;" type="number"
                                            class="sorting" name="sorting_{{ $job->id }}"
                                            id="sorting-{{ $job->id }}" value="{{ $job->priority ?? '0' }}"
                                            data-id="{{ $job->id }}">
                                    </td>
                                    <td>
                                        ...
                                        <a class="btn btn-warning btn-icon btn-circle"
                                            href="{{ route('job_experiences.edit', $job->id) }}"> <i
                                                class="fa fa-edit"></i></a>
                                        <form action="{{ route('job_experiences.destroy', $job->id) }}" method="POST"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="excelImportLabel">Job Experiences Import</h5>
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => 'job_experiences.import', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'import_form', 'files' => true]) !!}
                    ...
                    <div class="form-group text-center">
                        <a href="{{ asset('/sample-import/years_sample_import.xlsx') }}"> <i class="fas fa-download"></i>
                            Download
                            sample file </a>
                    </div>
...
@push('scripts')
    <script>
        $('.sorting').on('blur', function(e) {
            ...
            $.ajax({
                method: "POST",
                url: "{{ url('admin/sort_job_experiences') }}/" + id,
                data: {
                    "_token": "{{ csrf_token() }}",
                    sorting: value
                },
