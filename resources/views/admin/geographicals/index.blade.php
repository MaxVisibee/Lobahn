...
<!-- <div id="content" class="content"> -->
  ...
  <ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Geographical Experince</li>
  </ol>
  <!-- end breadcrumb -->

  <!-- begin page-header -->
  <h4 class="bold content-header">Geographical Experince Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-xs-6">
      <div>
        <a class="btn btn-primary" href="{{ route('geographicals.create') }}"><i class="fa fa-plus"></i>Create New Geographical Experince</a>            
      </div>
    </div>
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('geographicals.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div
    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- geo Opportunity Managements --></h4>
        ...
        <div class="panel-body">
          <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
            <thead>
              <tr>
                <th width="1%">No.</th>
                <th class="text-nowrap">Geographical Experince</th>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('geographicals.show',$geo->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('geographicals.destroy', $geo->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="excelImportLabel">Geographical Import</h5>
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'geographicals.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
        ...
        <div class="form-group text-center">
          <a href="{{asset('/sample-import/geographical_sample_import.xlsx')}}"> <i class="fas fa-download"></i> Download sample file </a>
        </div>
