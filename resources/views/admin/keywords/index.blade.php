...
@section('content')
  ...
  <!-- begin page-header -->
  <h4 class="bold content-header"> Keyword Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-xs-6">
      <div>
        <a class="btn btn-primary" href="{{ route('keywords.create') }}"><i class="fa fa-plus"></i> Create New Keyword</a>            
      </div>
    </div>
    <div class="col-xs-6 text-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="{{route('keywords.export')}}">Export</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
          <h4 class="panel-title"><!-- keyword Opportunity Managements --></h4>
        ...
        <div class="panel-body">
          <table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
            <thead>
              <tr>
                <th width="1%">No.</th>
                <th class="text-nowrap">Keyword Name</th>
              ...
              <tr>
                ...
                <td>
                 <!--  <a class="btn btn-success btn-icon btn-circle" href="{{ route('keywords.show',$keyword->id) }}"><i class="fas fa-eye"></i></a> -->
                  ...
                  <form action="{{ route('keywords.destroy', $keyword->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['route' => 'keywords.import', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'id'=>'import_form','files'=>true]) !!}
