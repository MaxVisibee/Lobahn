...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('job_skills.update', $data->id) }}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="job_skill" id="job_skill" class="form-control" value="{{ $data->job_skill }}">
                        </div>
                    </div>                    
                </div>
                <div class="row">
