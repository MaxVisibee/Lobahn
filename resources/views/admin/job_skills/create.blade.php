...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('job_skills.store') }}">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            <strong>Job Skill<span class="text-danger">*</span>:</strong>
                            <input type="text" name="job_skill" id="job_skill" class="form-control" value="{{old('job_skill')}}" placeholder="Job Skill">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-warning" href="{{ route('job_skills.index') }}">Back to Listing</a>
