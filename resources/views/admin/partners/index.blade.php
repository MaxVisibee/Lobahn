...
<!-- <div id="content" class="content"> -->
  ...
  <!-- begin page-header -->
  <h4 class="bold content-header"> Partners Management<small> </small></h4>
  <div id="footer" class="footer" style="margin-left: 0px"></div>
  <div class="row m-b-10">
    <div class="col-lg-12">
      <div>
        <a class="btn btn-primary" href="{{ route('partners.create') }}"><i class="fa fa-plus"></i> Create Partners</a>            
      </div>
    </div>
  </div
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-warning btn-icon btn-circle" href="{{ route('partners.edit',$partner->id) }}"> <i class="fa fa-edit"></i></a>
                  <form action="{{ route('partners.destroy', $partner->id) }}" method="POST" onsubmit="return confirm('Are you sure to Delete?');" style="display: inline-block;">
