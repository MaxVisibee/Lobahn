...
<!-- begin page-header -->
<h4 class="page-header">Create New District</h4>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('districts.store') }}">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            <strong>District Name<span class="text-danger">*</span>:</strong>
                            <input type="text" name="district_name" id="district_name" class="form-control" value="{{old('district_name')}}" placeholder="District Name">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
