                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select id="industry" name="industry" class="form-control">
                                    ...
                                    <option value="{{ $industry->id }}" data-grade="{{ $industry->industry_name }}">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select id="job_title" name="job_title" class="form-control">
                                    ...
                                    <option value="{{ $job_title->id }}" data-grade="{{ $job_title->job_title }}">
                                        {{ $job_title->job_title }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select id="country" name="country" class="form-control">
                                    ...
                                    <option value="{{ $country->id }}" data-grade="{{ $country->country_name }}">{{
