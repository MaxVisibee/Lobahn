                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            ...
                            <input type="text" name="question" id="question" class="form-control" value="{{old('question')}}" placeholder="Question">
                        </div>
                    </div>                    
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="answer" name="answer" class="form-control ckeditor"></textarea>
                        </div>
                    </div>                 
                </div>
                <div class="row">
