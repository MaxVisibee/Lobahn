...
@section('content')
    ...
    <!-- begin page-header -->
    <h4 class="page-header">Edit Faqs</h4>
    <!-- end page-header -->
        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    <form name="jobForm" id="jobForm" method="POST" action="{{ route('faqs.update', $data->id) }}">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="answer" name="answer"
                                        class="form-control">{{ old('answer', isset($data) ? $data->answer : '') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
