...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel-body">
            <form name="jobForm" id="jobForm" method="POST" action="{{ route('key_strengths.update', $data->id) }}">
                <input type="hidden" name="_method" value="PATCH">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group row m-b-15">
                            <strong>Key Strength Name<span class="text-danger">*</span>:</strong>
                            <input type="text" name="key_strength_name" id="key_strength_name" class="form-control" value="{{ $data->key_strength_name }}">
                        </div>
                    </div>                    
                </div>
                <div class="row">
