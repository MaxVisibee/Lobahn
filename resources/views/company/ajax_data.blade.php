<div class="overflow-x-auto">
    <table id="corporate-dashboard-table" class="corporate-dashboard-table mt-4 demo default footable" data-page-size="3"
        data-paging="true" data-page-navigation=".pagination" data-sorting="true" data-filtering="true"
        data-filter-placeholder="Search Actions" data-filter-dropdown-title="Sort Actions By:">
        <thead>
            <tr>
                ...
                <th>
                    <div class="tooltip">
                        ...
                        <span class="text-gray font-book text-sm inline-block bg-gray-light3 tooltiptext">Unviewed</span>
                    </div>
                </th>
                <th>
                    <div class="tooltip">
                        <img class="self-center m-auto" src="{{ asset('/img/corporate-menu/dashboard/eye2.svg') }}" />
                        <span class="text-gray font-book text-sm inline-block bg-gray-light3 tooltiptext">Viewed</span>
                    </div>
                ...
                <th>
                    <div class="tooltip">
                        ...
                        <span class="text-gray font-book text-sm inline-block bg-gray-light3 tooltiptext">Click</span>
                    </div>
                </th>
