                                ...
                                <ul class="w-full mt-5">
                                    <li
                                        ...
                                        <span class="text-base text-smoke letter-spacing-custom mb-0 cus_width-40">Company
                                            name </span>
                                        <span class="text-gray text-base ml-2" id="company-profile-name">{{ $company->company_name }}</span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <span class="text-base text-smoke letter-spacing-custom cus_width-46">Office
                                            telephone</span>
                                        <span class="text-gray text-base ml-2" id="company-profile-phone">{{ $company->phone }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="highlights-member-profile pl-1">
                                <ul class="w-full mt-2">
                                    <li class="bg-gray-light3 rounded-corner py-2 px-4">
                                        ...
                                        <span class="text-base text-gray ml-2" id="company-website">{{ $company->website_address }}</span>
                                    </li>
                                    <li class="flex bg-gray-light3 rounded-corner py-2 px-4 mt-3 mb-4 description-box">
                                        ...
                                        <span id="view-description" class="text-base text-gray ml-2">{{ $company->description }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
