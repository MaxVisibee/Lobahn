                                ...
                                <ul class="w-full mt-5">
                                    ...
                                    <li class="flex bg-gray-light3 rounded-corner py-3 px-4 2xl:px-8 lg:h-11 mt-2 flex-ic">
                                        ...
                                        <span class="text-base text-gray ml-2"
                                            id="company-profile-username">_username_</span>
                                    </li>
                                    <li class="flex bg-gray-light3 rounded-corner py-3 px-4 2xl:px-8 lg:h-11 mt-2 flex-ic">
                                        <span class="text-base text-smoke letter-spacing-custom cus_width-32">Office email
                                        </span>
                                        <span class="text-base text-gray ml-2"
                                            id="company-profile-email">company@email.com</span>
                                    </li>
                                    <li
                                        ...
                                        <span class="text-base text-smoke letter-spacing-custom cus_width-46">Office
                                            telephone</span>
                                        <span class="text-gray text-base ml-2" id="company-profile-phone">+852 1234
                                            5678</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="highlights-member-profile pl-1">
                                <ul class="w-full mt-2">
                                    <li class="bg-gray-light3 rounded-corner py-2 px-4">
                                        ...
                                        <span class="text-base text-gray ml-2" id="company-website">company website</span>
                                    </li>
                                    <li class="flex bg-gray-light3 rounded-corner py-2 px-4 mt-3 mb-4 description-box">
                                        ...
                                        <span id="view-description" class="text-base text-gray ml-2">Brief description of
                                            company. Snappy & attractive. Five lines maximum. Brief description of company.
                                            Snappy & attractive. Five lines maximum. Brief description of company. Snappy &
                                            attractive. Five lines maximum. Brief description of company. Snappy &
                                            attractive. Five lines maximum.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
