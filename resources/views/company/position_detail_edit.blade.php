                                ...
                                <div id="position-detail-edit-languages" class="w-full position-detail-edit-languages">
                                    <div id="languageDiv1" class="flex justify-between  gap-1 mt-2">
                                                    ...
                                                    <button data-value='Cantonese'
                                                        ...
                                                        <div class="position-detail-language flex justify-between">
                                                            <span
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="position-detail-language text-lg font-book">Select</span>
                                                                @endif
                                                            </span>
                                                    ...
                                                    <ul id="position-detail-language-ul"
                                                        ...
                                                        @foreach ($languages as $language)
                                                            <li
                                                                ...
                                                                <input name='position-detail-language-select-box-checkbox'
                                                                    type="radio" name="ui_language1"
                                                                    @if (isset($user_language[0])) @if ($language->id == $user_language[0]['language_id'])
                                                                    checked="checked" @endif
                                                                    @endif
                                                                data-target='{{ $language->language_name }}'
                                                                class="position-detail-language" /><label
                                                                    class="position-detail-language text-lg pl-2 font-normal text-gray">{{ $language->language_name }}</label>
                                        ...
                                        <div class="4xl-custom:w-2/5 w-2/6 flex justify-between">
                                            <div class="flex w-full rounded-lg">
                                                <div class="mb-3 position-detail w-full relative">
                                                    <div id="position-detail-languageBasic" class="dropdown-check-list"
                                                        tabindex="100">
                                                            ...
                                                            @foreach ($language_levels as $language_level)
                                                                <li
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value='{{ $language_level->level }}' type="radio"
                                                                        @if (isset($user_language[0])) @if ($language_level->id == $user_language[0]['level_id'])
                                                                        checked="checked" @endif
                                                                        @endif
                                                                    data-target='{{ $language_level->level }}'
                                                                    class="position-detail-languageBasic " /><label
                                                                        class="position-detail-languageBasic text-lg pl-2 font-normal text-gray">{{ $language_level->level }}</label>
                                    ...
                                    <div id="languageDiv2" class="hidden flex justify-between  gap-1 mt-2">
                                                    ...
                                                    <ul id="position-detail-language1-ul"
                                                        ...
                                                        @foreach ($languages as $language)
                                                            <li
                                                                ...
                                                                <input name='position-detail-language1-select-box-checkbox'
                                                                    type="radio" name="ui_language2"
                                        ...
                                        <div class="4xl-custom:w-2/5 w-2/6 flex justify-between">
                                            <div class="flex w-full rounded-lg">
                                                <div class="mb-3 position-detail w-full relative">
                                                    <div id="position-detail-languageBasic1" class="dropdown-check-list"
                                                        tabindex="100">
                                                        <button data-value='Basic'
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="position-detail-languageBasic1 md:mr-12 mr-1  py-1 text-gray text-lg selectedText">
                                                                    @if (count($user_language) > 1 && $user_language[1]['level_id'] != null)
                                                                        <span
                                                                            class="text-lg font-book">{{ $user_language[1]->level->level ?? 'Select' }}</span>
                                                                    @else
                                                                        <span class="text-lg font-book">Select</span>
                                                                    @endif
                                                                </span>
                                    ...
                                    <div id="languageDiv3" class="hidden flex justify-between  gap-1 mt-2">
                                                ...
                                                <div id="position-detail-language2" class="dropdown-check-list"
                                                    ...
                                                    <button data-value='Cantonese'
                                                        ...
                                                        <div class="position-detail-language2 flex justify-between">
                                                            <span
                                                                class="position-detail-language2 md:mr-12 mr-1  py-1 text-gray text-lg selectedText">
                                                    ...
                                                    <ul id="position-detail-language2-ul"
                                                        ...
                                                        @foreach ($languages as $language)
                                                            <li
                                                                ...
                                                                <input name='position-detail-language2-select-box-checkbox'
                                        ...
                                        <div class="4xl-custom:w-2/5 w-2/6 flex justify-between">
                                            <div class="flex w-full rounded-lg">
                                                <div class="mb-3 position-detail w-full relative">
                                                    <div id="position-detail-languageBasic2" class="dropdown-check-list"
                                                        tabindex="100">
                                                        <button data-value='Basic'
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="position-detail-languageBasic2 md:mr-12 mr-1 py-1 text-gray text-lg selectedText">
                                                            ...
                                                            @foreach ($language_levels as $language_level)
                                                                <li
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        data-value='{{ $language_level->level }}'
                                                                        type="radio"
