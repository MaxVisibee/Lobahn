        ...
        <div class="bg-white  py-12 md:px-10 px-4 rounded-md">
                ...
                <div class="">
                    ...
                    <div class="flex justify-between  bg-gray-light3">
                        <input id="expired-date" name="expire_date"
                            value="{{ date('d M , Y', strtotime($opportunity->expire_date)) }}" class="text-gray text-lg pl-4 border-none
                            ...
                            <button class="text-lg font-book w-full btn btn-default  dropdown-toggle botn-todos"
                                ...
                                <div class="flex justify-between">
                                    <span class="text-lg font-book">
                                        @if($opportunity->is_active) Open @else
                                        Close
                                        @endif
                                    </span>
            ...
            <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-4">
                <div class="col-span-1">
                    ...
                    <div
                        class="md:flex justify-between mb-2 position-target-pay2 @if($opportunity->full_time_salary) hidden @endif">
                        <div class="md:w-2/5">
                    ...
                    <div
                        class="md:flex justify-between mb-2 position-target-pay4 @if($opportunity->part_time_salary) hidden @endif">
                        <div class="md:w-2/5">
                    ...
                    <div
                        class="md:flex justify-between mb-2 position-target-pay5 @if($opportunity->freelance_salary) hidden @endif">
                        <div class="md:w-2/5">
                        ...
                        <div class="md:w-3/5 flex justify-between rounded-lg">
                            <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                ...
                                <ul class="dropdown-menu management-level-dropdown bg-gray-light3 w-full"
                                    ...
                                    <li><a><input @if($carrier->id == $opportunity->carrier_level_id) checked @endif
                        ...
                        <div class="md:w-3/5 flex justify-between  rounded-lg">
                            <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                <button class="text-lg font-book w-full btn btn-default  dropdown-toggle botn-todos"
                                    ...
                                    aria-expanded="false">
                                    <div class="flex justify-between">
                                        <span class="text-lg font-book">{{ $opportunity->peopleManagementLevel->level ??
                                            'Select' }}</span>
                                        <span class="custom-caret flex self-center"></span>
                                    </div>
                                </button>
                                ...
                                <div id="languageDiv1" class="flex flex-wrap justify-between gap-1 mt-2">
                                    <div class="w-2/4 flex justify-between bg-gray-light3 rounded-lg">
                                        <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                            ...
                                            <ul class="dropdown-menu language-dropdown bg-gray-light3 w-full"
                                                ...
                                                <li class="cursor-pointer language-name languageSelect"><a
                                                        ...
                                                        <input value="{{ $language->language_name }}"
                                                            name="ui_language1" type="radio" @if(isset($user_language[0])) @if($language->id == $user_language[0]['language_id'])
                                                        checked="checked"
                                                        @endif
                                                        @endif>
                                            ...
                                            <input class="language_name" type="hidden" name="language_1" @if($user_language && count($user_language)> 0) value="{{
                                ...
                                <div id="languageDiv2" class="hidden flex flex-wrap justify-between  gap-1 mt-2">
                                    <div class="w-2/4 flex justify-between bg-gray-light3 rounded-lg">
                                        <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                            ...
                                            <input class="language_name" type="hidden" name="language_2" @if($user_language && count($user_language)> 1) value="{{
                                        ...
                                        <div class="flex w-full bg-gray-light3 rounded-lg">
                                            <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                                <button
                                                    ...
                                                    aria-expanded="false">
                                                    <div class="flex justify-between">
                                                        @if(count($user_language) > 1 && $user_language[1]['level_id'] !=
                                                        null)
                                                        <span class="text-lg font-book">$user_language[1]->level->level ?? 'Select'
                                                            }}</span>
                                                        @else
                                                        <span class="text-lg font-book">Select</span>
                                                        @endif</span>
                                ...
                                <div id="languageDiv3" class="hidden flex flex-wrap justify-between  gap-1 mt-2">
                                    <div class="w-2/4 flex justify-between bg-gray-light3 rounded-lg">
                                        <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                            ...
                                            <input class="language_name" type="hidden" name="language_3" @if($user_language && count($user_language)> 2) value="{{
                                        ...
                                        <div class="flex w-full bg-gray-light3 rounded-lg">
                                            <div class="btn-group dropdown w-full position-detail-dropdown" id="">
                                                <button
                                                    ...
                                                    aria-expanded="false">
                                                    <div class="flex justify-between">
                                                        @if(count($user_language) > 2 && $user_language[2]['level_id'] !=
                                                        null)
                                                        <span class="text-lg font-book">{{ $user_language[2]->level->level ?? 'Select'
                                                            }}</span>
                                                        @else
                                                        <span class="text-lg font-book">Select</span>
                                                        @endif
                        ...
                        <div class="md:w-3/5 flex justify-between  rounded-lg">
                            <div id="Specialties-dropdown-container" class="Specialties-dropdown-container w-full">
                                <select id="Specialties-dropdown" name="specialist_id[]"
                                    ...
                                    <option value="{{ $specialty->id }}" data-grade="{{ $specialties }}" @if(in_array($specialty->id, $specialty_selected)) selected @endif>
                        ...
                        <div class="md:w-3/5 flex justify-between y-2 rounded-lg">
                            <div id="Desirable-dropdown-container" class="Desirable-dropdown-container w-full">
                                <select id="Desirable-dropdown" class="Desirable-dropdown custom-dropdown"
                                    ...
                                    <option value="{{ $company->id }}" data-grade="{{ $companies }}" @if(in_array($company->id, $target_employer_selected)) selected @endif>
