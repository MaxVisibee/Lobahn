                                ...
                                <p class="text-gray-pale text-lg ml-3">
                                    @isset($languages)
                                        @if (count($languages) > 1)
                                            {{ $languages[0]->language->language_name ?? ' ' }} +
                                            {{ count($languages) - 1 }}
                                        @else
                                ...
                                <div class="grid sm:grid-cols-3 py-5 lg:py-8 mr-3 border-b border-gray-pale">
                                    <div class="sm:col-span-2">
                                        <p class="text-white font-book text-xl sm:text-2xl">
                                            {{ $employment_history->position->job_title ?? 'no data' }}</p>
                                        {{-- <span
                                    ...
                                    <div class="col-span-1 sm:text-right">
                                        <span
                                            class="text-white font-book text-xl sm:text-2xl">{{ date('d M Y', strtotime($employment_history->from)) }}
                                            <br> -
                                            @if (is_null($employment_history->to))
                                                Present
                                            @else
                                                {{ date('d M Y', strtotime($employment_history->to)) }}
                                            @endif
                                        </span>
                                    </div>
                                </div>
