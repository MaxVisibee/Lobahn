...
<div class="bg-gray-light2 corporate-dashboard-menu 4xl-custom:pt-40 md:pt-36 pt-64 pb-32">
    <div class="xl:flex md:justify-between bg-lime-orange px-8 py-8">
        <div>
            <div class="xl:flex">
                <div class="flex">
                    <img class="flex self-start pt-2" src="./img/corporate-menu/dashboard/active.svg" />
                    <p class="flex flex-wrap text-2xl text-gray pl-2 uppercase">
                        <a href="/position-detail.html" class="cursor-pointer hover:underline">Marketing Communications Manager</a>
                        <img class="pt-1" src="./img/corporate-menu/dashboard/linkicon.svg" />
                    </p>
        ...
        <div class="md:flex xl:mt-0 mt-4">
            <div class="flex md:mt-0 mt-4 self-center">
                <p class="text-gray text-base flex self-center md:mr-1 whitespace-nowrap xl:ml-4 
                md:ml-6 ml-2">Sory by</p>
        ...
        <div class="overflow-x-auto">
            <table id="corporate-position-table" class="corporate-position-table w-full">
                <tr class="mt-4 cursor-pointer" data-target="corporate-view-feature-staff-popup">
                    <td class=""> 
                        <span class="bg-lime-orange border border-lime-orange text-gray text-lg rounded-full px-3 pb-0.5 inline-block mb-2">Featured</span>
                    </td>
                ...
                <tr class="mt-4 cursor-pointer" data-target="corporate-view-staff-popup">
                    ...
                    <td>
                        <div class="cursor-pointer inline-block px-3 text-sm text-center font-book 
                ...
                <tr class="mt-4 cursor-pointer" data-target="corporate-view-staff-popup">
                    ...
                    <td>
                        <div class="cursor-pointer inline-block px-5 font-book text-sm text-center 
