    ...
    <div class="xl:flex md:justify-between bg-lime-orange px-8 py-6 mt-2">
        ...
        <div class="lg:flex xl:mt-0 mt-4">
            <div class="md:flex">
                ...
                <input class="bg-gray-light3 appearance-none border-2 border-gray-light2
                        rounded-lg md:w-72 py-3 md:px-8 px-3 text-gray leading-tight flex justify-center self-center
                        focus:outline-none focus:bg-gray-light2 border-none search" type="text" value="">
            </div>
        ...
        <div class="overflow-x-auto">
            <table id="corporate-dashboard-table" class="corporate-dashboard-table mt-4 demo default footable"
                ...
                <tbody>
                    ...
                    <tr class="mt-4">
                        <td class="whitespace-nowrap footable-first-column">{{ $listing->ref_no ? $listing->ref_no : '-'
                            }}</td>
                        ...
                        <td class=" font-book" class="whitespace-nowrap">{{ $listing->expire_date
                            }}</td>
