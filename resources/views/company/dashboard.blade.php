...
@section('content')
    <div class="bg-gray-light2 corporate-dashboard-menu pb-36">
        <div class="grid xl:grid-cols-4 md:grid-cols-2 gap-2 pb-2">
            <div class="md:col-span-2 bg-white flex rounded-lg py-8 xl:mr-2">
                <div class="md:flex w-full sm:px-8 px-2">
                    ...
                    <div class="md:ml-8 md:w-70percent w-full">
                        <div class="flex justify-between">
                            ...
                            <div class="cursor-pointer" onclick="window.location='{{ route('company.profile.edit') }}'">
            ...
            <div class="md:col-span-1 bg-white rounded-lg py-8 flex justify-center md:mr-2">
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-center text-4xl text-gray font-heavy">
                                {{ number_format($company->total_impressions) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="md:col-span-1 bg-white rounded-lg py-8 flex justify-center">
                <div class="self-center">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-center  text-4xl text-gray font-heavy">{{ number_format($company->total_clicks) }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="xl:flex md:justify-between bg-lime-orange px-8 py-6 mt-2">
            <div class="md:flex">
                ...
                <div class="flex self-center hidden">
            ...
            <div class="overflow-x-auto">
                <table id="corporate-dashboard-table" class="corporate-dashboard-table mt-4 demo default footable"
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="tooltip">
                                <img class="self-center m-auto" src="./img/corporate-menu/dashboard/shortlist.svg" />
                                <span
                    ...
                    @foreach ($listings as $listing)
                        <tr class="mt-4">
                            ...
                            <td class="text-center font-book"><a href="{{ route('company.positions', $listing->id) }}"
                                    class="hover:underline cursor-pointer">{{ $listing->title }}</a></td>
                            <td class="text-center font-book">
                            ...
                            <td class="text-center font-book">2,222</td>
