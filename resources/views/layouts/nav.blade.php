<div class="w-auto top-0 fixed  md:bg-transparent bg-gray home-menu">
    <div class="flex homemenu-bg-div justify-between w-full items-center bg-transparent lg:px-14 md:px-9 pr-4">
        ...
        <div class="md:justify-start">
            <img src="{{ asset('/img/lobahn-white.svg') }}" alt="company logo" class="cursor-pointer companymenu-logo"
        ...
        <div class="md:flex hidden justify-around md:order-none order-2 ">
            <p class="justify-center text-21 text-gray-pale whitespace-nowrap hover:text-lime-orange font-book">
                <a href="{{ route('connect') }}" class="cursor-pointer hover:text-lime-orange font-book">Lobahn
                    Connect™</a>
            </p>
            @if (!Auth::user() && !Auth::guard('company')->user())
                <p
                ...
                <p
                    class="md:flex md:flex md:mb-0 text-21 text-gray-pale whitespace-nowrap md-custom:ml-4 hover:text-lime-orange font-book">
                    <a href="{{ route('login') }}" class="cursor-pointer  hover:text-lime-orange font-book">Login</a>
                </p>
            @else
                @if (Auth::check())
                    <p
