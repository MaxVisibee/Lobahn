...
<div class="bg-gray-light">
    <div class="mx-auto relative pt-20 sm:pt-32 pb-10 sm:pb-12 footer-section-div">
        <ul class="flex flex-wrap justify-between text-center items-center text-base md:text-lg xl:text-2xl letter-spacing-custom mx-auto footer-menu-bar mb-20 w-full">
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Lobahn Connect<sup class="top-0">TM</sup></a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Membership</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Events</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Community</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">News & Views</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Career Partner<sup class="top-0">TM</sup></a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Talent Discovery<sup class="top-0">TM</sup></a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">FAQ</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Terms</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Privacy Policy</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">My Account</a></li>
            <li class="w-1/6 mb-3"><a href="#" class="text-gray-pale hover:text-lime-orange focus:outline-none">Contact</a></li>
        ...
        <div class="flex flex-row flex-wrap mt-32 mb-16 footer-contact-box">
                ...
                <div class="flex flex-row flex-wrap justify-between items-center footer-social-bar">
                    ...
                    <a href="#" class="linkedin-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36.171" height="36" viewBox="0 0 36.171 36">
                            ...
                            <path id="Path_47" data-name="Path 47" d="M95.229,0H64.543A2.928,2.928,0,0,0,61.8,2.571V33.429A2.675,2.675,0,0,0,64.543,36H95.229a2.928,2.928,0,0,0,2.743-2.571V2.571A2.675,2.675,0,0,0,95.229,0ZM72.6,30.686H67.286V13.543H72.6ZM69.857,11.143a3.086,3.086,0,1,1,3.086-3.086A3.073,3.073,0,0,1,69.857,11.143Zm22.8,19.543H87.343v-8.4c0-2.057,0-4.629-2.743-4.629s-3.257,2.229-3.257,4.457v8.571H76.029V13.543h5.143v2.4A5.406,5.406,0,0,1,86.143,13.2c5.486,0,6.343,3.6,6.343,8.229Z" fill="#707070"/>
                            </g>
                        </svg>
                    </a>
                    <a href="#" class="twitter-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="29.252" viewBox="0 0 36 29.252" class="footer-social-bar__twitter">
                            <path id="Path_90" data-name="Path 90" d="M86.321,127.7c13.585,0,21.015-11.255,21.015-21.015,0-.32,0-.638-.022-.955A15.028,15.028,0,0,0,111,101.909a14.743,14.743,0,0,1-4.242,1.162A7.412,7.412,0,0,0,110,98.986a14.8,14.8,0,0,1-4.69,1.793,7.393,7.393,0,0,0-12.587,6.736A20.969,20.969,0,0,1,77.506,99.8a7.392,7.392,0,0,0,2.287,9.86,7.331,7.331,0,0,1-3.352-.924v.094a7.389,7.389,0,0,0,5.926,7.24,7.374,7.374,0,0,1-3.335.127,7.394,7.394,0,0,0,6.9,5.129,14.82,14.82,0,0,1-9.173,3.168A15.034,15.034,0,0,1,75,124.385,20.91,20.91,0,0,0,86.321,127.7" transform="translate(-75 -98.45)" fill="#707070"/>
                          </svg>
            ...
            <div class="footer-contact-center-div">
                ...
                {{csrf_field()}}
                    <div class="footer-contact mb-4">
                        <input type="email" name="email" id="email" placeholder="Your email" class="focus:border-none email-input pl-7 bg-gray text-gray-pale text-lg py-4 rounded-corner w-full"/>
                    </div>

                    <div class="footer-contact mb-4">
                    <input type="text" name="name" id="name" placeholder="Your name" class="focus:border-none name-input pl-7 bg-gray text-gray-pale text-lg py-4 rounded-corner w-full"/>
                    </div>
                    <div class="footer-contact">
                    <textarea class="message-text pl-7 bg-gray text-gray-pale text-lg py-4 rounded-corner w-full footer-contact-textarea focus:border-none" placeholder="Message"  name="comment" id="comment"></textarea>
                    </div>
            </form>
        ...
        <div class="">
            <p class="text-sm text-gray-pale letter-spacing-custom">&copy;2022 Lobahn Technology Limited. All rights reserved.<span class="block">Lobahn<sup class="top-0">&reg;</sup>, Lobahn Connect<sup class="top-0">TM</sup>, Career Partner<sup class="top-0">TM</sup>, Talent Discovery<sup class="top-0">TM</sup>, JSR<sup class="top-0">TM</sup> and JSR Rating<sup class="top-0">TM</sup> are registered trademarks of Lobahn Technology Limited. HK EA licence no. 66450. </span>
            </p>
        </div>
    </div>
</div>
