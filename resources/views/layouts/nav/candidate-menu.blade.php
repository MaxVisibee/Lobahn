    ...
    <div class="md:flex justify-between bg-gray-light lg:px-14 px-4 md:py-8 py-4 corporate-menu-icon-margin">
        ...
        <div class="gap-4">
            <div class="flex justify-between items-center">
                ...
                <p class=" xl:text-21 md:text-lg text-base text-gray-pale whitespace-nowrap font-book">Career Partner™</p>
                <div class="mx-4 flex justify-center md:mr-auto corportate-menu-btn"  id="corportate-menu-btn">
                    ...
                    <div class="fixed top-0 w-full h-screen left-0 z-20 bg-gray-opacity hide notifications-popup-container" id="notifications-popup">   
                    ...
                    <div class="flex justify-end  pt-36 xl:pr-14 md:pr-8 pr-4">
                        <div class="text-right">
                            ...
                            <a href="#" class="block mb-4">
                                <p class="text-gray-pale text-21 font-book hover:text-lime-orange">Career Partner™</p>
                            </a>
