  <div class="corporate-member-menu ">
      <div
          ...
          <div class="lg:w-1/5 w-full self-center md:mx-0 mx-auto">
              <p
          ...
          <div class="lg:w-2/5 w-full gap-4 self-center xl:pl-40 lg:pl-8 md:pl-4 pl-0 md:mx-0 mx-auto profile-edit-menu">
              <div class="flex justify-between items-center">
                  ...
                  <div id="corporate-menu-icon" class="corporate-menu-icon flex ml-6">
                      ...
                      <div class="corporate-menu-content overflow-y-auto absolute hidden -mt-12 right-0">
                          <div class="flex justify-end  pt-36 xl:pr-14 md:pr-8 pr-4 corporate-menu-content-div">
                              <div class="text-right">
                                  ...
                                  <a href="{{ route('candidate.setting') }}" class="block mb-4">
                                      <p class="mb-4 text-gray-pale text-21 font-book hover:text-lime-orange">Settings
                                      </p>
                                  </a>
