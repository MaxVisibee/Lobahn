...
<head>
    <title>Corporate - New Profile</title>
    <style>
...
<body class="body-div">
    <div class="body-bg-color">
        ...
        <div class="template-white-card connection-title">
            <p class="head-title" style="text-align: center;font-weight: bold;">New Profile Received</p>
            <img src="{{asset('img/chris-wong.png')}}" style="display:block;border-radius:50%;" />
            <img src="{{ asset('/img/chris-wong.png')}}) }}" style="display:block;border-radius:50%;" />
            <p style="font-weight: bold;">Position Title:<br />
                <span style="font-weight: normal;">{{ $position_title }}</span>
            </p>

            <p style="font-weight: bold;">JSR™ Score:<br />
                <span style="font-weight: normal;">{{ $jsr_score }}%</span>
            </p>

            <p style="font-weight: bold;">Member Name:<br />
                <span style="font-weight: normal;">{{ $candidate_name }}</span>
            </p>

            <p style="font-weight: bold;">Position:<br />
                <span style="font-weight: normal;">Head of Marketing - B2B Services,<br>
                    Creative & Design</span>
            </p>
            <p style="font-weight: bold;">Employer:<br />
                <span style="font-weight: normal;">DDB Group Hong Kong</span>
            </p>
