    ...
    <table class="gray-bg" style="background-color: #FFFFFF;width: 80%;margin: 0  auto;padding: 50px 50px 0;">
        ...
        <tr>
            <td class="order-mail" style="padding: 0 21px;">
                <h1 class="header-one" style="font-size: 13px;font-weight: normal;font-family: 'Ubuntu', sans-serif;">Dear {{ $register->user_name ?? ''}},</h1>
                <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">Congratulations ! You are receiving this email because your have successfully event registered. Thank you for filling out our register form</p>
            </td>
        </tr>  
    </table>
