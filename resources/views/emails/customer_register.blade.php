        ...
        <table class="gray-bg" style="background-color: #FFFFFF;width: 80%;margin: 0  auto;padding: 50px 50px 0;">
            ...
            <tr>
                <td class="order-mail" style="padding: 0 21px;">
                    <h1 class="header-one"
                        style="font-size: 13px;font-weight: normal;font-family: 'Ubuntu', sans-serif;">Dear
                        {{ $user->name ?? '' }},</h1>
                    <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">You are receiving this email because
                        your account is created successfully.</p>
                    <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">You can login and view your
                        profile.Links to useful information ,and anything else you think your participants should know.
                    </p>
                </td>
            </tr>
            <tr>
