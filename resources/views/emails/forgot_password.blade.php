    ...
    <table class="gray-bg" style="background-color: #FFFFFF;width: 80%;margin: 0  auto;padding: 50px 50px 0;">
        ...
        <tr>
            <td class="mail-link" style="padding: 0 21px 21px;">
                ...
                <!-- <a href="{{$url_link}}" style="font-family: 'Ubuntu', sans-serif;font-size: 13px;color: #2670e0;top: 10px;bottom: 10px;position: relative;">{{$url_link}}</a> -->
                <a href="#" style="font-family: 'Ubuntu', sans-serif;font-size: 13px;color: #2670e0;top: 10px;bottom: 10px;position: relative;">password_reset link</a>
            </td>
        </tr>  
    </table>
