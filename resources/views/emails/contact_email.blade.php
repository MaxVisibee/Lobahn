    ...
    <table class="gray-bg" style="background-color: #FFFFFF;width: 80%;margin: 0  auto;padding: 50px 50px 0;">
        ...
        <tr>
            <td class="order-mail" style="padding: 0 21px;">
                <h1 class="header-one" style="font-size: 13px;font-weight: normal;font-family: 'Ubuntu', sans-serif;">Dear Admin,</h1>
                <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">You are receiving this email from customer comment from the website contact form. Please, carefully view the details.</p>
                <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">Name : {{ $name ?? ''}}</p>
                <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">Email : {{ $email ?? ''}}</p>
                <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">Comment : {{ $comment ?? ''}}</p>
            </td>
        </tr>
    </table>
