        ...
        <table class="gray-bg" style="background-color: #FFFFFF;width: 80%;margin: 0  auto;padding: 50px 50px 0;">
            ...
            <tr>
                <td class="order-mail" style="padding: 0 21px;">
                    <h1 class="header-one"
                        style="font-size: 13px;font-weight: normal;font-family: 'Ubuntu', sans-serif;">Dear Name,</h1>
                    <p style="font-family: 'Ubuntu', sans-serif;font-size: 13px;">hay, We’re almost done. Your account
                        is created. Now you just need to verify it.</p>
                </td>
            </tr>
            <tr>
                <td class="mail-link" style="padding: 0 21px 21px;">
                    ...
                    <a href="{{ $link . '?email=' . urlencode($user->email) }}"
                        style="font-family: 'Ubuntu', sans-serif;font-size: 13px;color: #2670e0;top: 10px;bottom: 10px;position: relative;">{{ $link }}</a>
                </td>
            </tr>
        </table>
