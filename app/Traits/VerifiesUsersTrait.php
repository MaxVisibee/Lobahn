...
trait VerifiesUsersTrait
{
    ...
    public function getVerification(Request $request, $token)
    {
        ...
        try {
            ...
            return redirect($this->redirectIfVerified($token, $request->input('email')));
        ...
        return redirect($this->redirectAfterVerification($token, $request->input('email')));
    }
